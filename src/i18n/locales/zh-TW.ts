...
const zhTW: ResourceTree = {
  ...
  "models": {
    ...
    "ui": {
      ...
      "fiveHour": { "start": "啟動 5h", "starting": "啟動中…", "hint": "使用這個帳號送出一筆極小的 Luna 請求，以啟動 5 小時用量視窗。會消耗少量額度，但不會使用 Reset。", "success": "已觸發 5 小時視窗並重新讀取用量。", "failed": "無法觸發 5 小時視窗：{{detail}}", "refreshFailed": "觸發請求已完成，但無法重新讀取用量：{{detail}}" },
