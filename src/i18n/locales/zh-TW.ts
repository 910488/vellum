...
const zhTW: ResourceTree = {
  "enhanced": {"heading":"Enhanced 執行狀態","lead":"顯示每條路由的執行者、相容性檢查結果，以及手機連線狀態。","title":"Enhanced Core","subtitle":"執行者、相容性證據與手機連線","serving":"Enhanced Core 運作中","notServing":"Enhanced Core 未運作","sessions":"已觀察到的工作階段","running":"執行中的回合","freshness":"資料時間","restartRequired":"已備妥新的啟動設定。請在進行中的回合結束後再安全重新啟動。","launchCoreDrift":"Codex Desktop 已更新核心。Vellum 會在回合閒置時自動重新啟動 Proxy；完成後請重新啟動 Codex。","now": "現在", "runningTurns_one": "{{count}} 個回合執行中", "runningTurns_other": "{{count}} 個回合執行中", "sessionCount_one": "{{count}} 個工作階段", "sessionCount_other": "{{count}} 個工作階段", "verdict": {"serving": "Codex Desktop 目前經由 Enhanced Core 執行。", "servingOtherLaunch": "Enhanced 仍在運作，但沿用上一次啟動的設定。重新啟動 Codex 才會切換到這次的設定。", "stoppedAt": "啟動流程停在「{{link}}」階段。", "disabled": "Enhanced Core 已停用，Codex Desktop 正使用原生核心。"}, "chain": {"title": "啟動流程", "artifact": "元件驗證", "armed": "路徑接管", "adopted": "Bridge 接手", "inPlace": "執行確認"}, "mark": {"blocked": "未通過", "waiting": "等待中", "inPlace": "已生效"}, "whyStopped": "在「{{link}}」階段停下的原因", "whyNoted": "執行中，但有幾點需要注意", "protocol": {"verified": "已驗證", "unverified": "未驗證", "incompatible": "不相容"}, "protocolUnrun": "比對尚未執行", "unverifiedNote": "這個 Codex Desktop 版本沒有經過驗證。路由會用到的方法都還在，所以路由沒有問題；下方列出的差異確實存在，但未經測試 —— 可以用，但不保證正確。", "missingHelpers": "Enhanced 核心少了官方安裝中有的輔助程式：{{list}}。對話與路由不受影響，只有沙箱命令執行會失敗。", "routed": "路由所需", "delta": {"methodUnservable": "此方法無法提供", "methodUnknownToDesktop": "Desktop 未宣告此方法", "fieldNewlyRequired": "欄位變成必填", "fieldRemoved": "欄位已移除"}, "environment": {"leased": "持有中", "released": "已交還", "orphanedBridge": "殘留的舊 Bridge", "foreignValue": "由其他工具設定", "unreadable": "無法讀取"}, "bridgeProcess": "Bridge 程序", "bridgeState": "Bridge 狀態", "children": "子程序", "launch": "啟動", "relayNote": "手機要連上，必須通過握手、任務清單、訊息載入、即時事件與任務控制五個階段；哪一關沒過，就是連不上的原因。", "staleWarning":"顯示的是最後一次觀察結果，可能已經過期。","compatibility":"版本與相容性","activeRuntime":"目前實際使用的 runtime","candidateRuntime":"下次啟動使用的 runtime","structure":"Schema 比較","qualification":"最近驗證","notObserved":"尚未觀察","observed":"已觀察","evidenceNote":"Schema 一致只能算是結構上的證據，不能證明 Desktop 或手機的行為已經驗證過。","differences":"差異與阻礙","relay":"Relay 狀態","clients":"已連線的用戶端版本","handshake":"握手","list":"任務清單","history":"訊息載入","stream":"即時事件","control":"任務控制","failureStage":"最後失敗階段","plane":"執行者","all":"全部","empty":"這次啟動還沒有觀察到任何工作階段。過去的綁定不等於目前的連線。","session":"工作階段","state":"狀態","lastActivity":"最後活動時間","parent":"父任務","diagnostics":"診斷","recheck":"重新檢查相容性","export":"匯出診斷","exported":"已儲存","states":{"starting":"啟動中", "ready":"就緒", "degraded":"降級", "stopped":"已停止", "transportReady":"傳輸就緒", "unknown":"未知","current":"最新","stale":"已過期","offline":"離線","unavailable":"沒有資料","running":"執行中","idle":"閒置","approval":"等待核准","unloaded":"已卸載","observed":"已觀察","attached":"已連接","failed":"失敗"}},
  "common": { "expiresAt": "到期時間：{{month}}月{{day}}日 {{time}}（{{zone}}）", "expiredAlready": "已過期", "expiresInMinutes": "剩 {{value}} 分鐘", "expiresInHours": "剩 {{value}} 小時", "expiresInDays": "剩 {{value}} 天","emDash": "—", "none": "—", "listSeparator": "；", "itemSeparator": "、", "loading": "讀取中…", "processing": "處理中…", "refreshing": "更新中…", "refresh": "重新整理", "reorganize": "重新整理", "save": "儲存", "cancel": "取消", "confirm": "確認", "close": "關閉", "remove": "移除", "enabled": "啟用", "disabled": "停用", "yes": "是", "no": "否", "on": "開", "off": "關", "unknown": "未知", "provider": "Provider", "model": "模型", "proxy": "Proxy", "codexCatalog": "Codex 模型選單", "justNow": "剛剛", "minutesAgo": "{{count}} 分鐘前", "hoursAgo": "{{count}} 小時前", "daysAgo": "{{count}} 天前", "resetAt": "{{month}}月{{day}}日 {{time}} 重設", "previousPage": "上一頁", "nextPage": "下一頁", "pageOf": "第 {{page}} / {{total}} 頁", "shortcutTitle": "{{label}}（Ctrl+{{n}}）", "statusUpdateFailed": "狀態更新失敗：{{detail}}", "errorWithDetail": "{{message}}：{{detail}}", "connectionFailed": "連線失敗", "operationFailed": "操作失敗", "loadFailed": "載入失敗", "saveFailed": "儲存失敗", "visible": "顯示", "hidden": "隱藏", "totalItems_one": "共 {{count}} 筆", "totalItems_other": "共 {{count}} 筆", "itemsNeedAttention_one": "個項目需要處理", "itemsNeedAttention_other": "個項目需要處理", "notice": {"info": "提示", "warn": "注意", "error": "失敗"}, "dismiss": "知道了"},
  "navigation": {
    "mainAria": "主導覽",
    "today": {
      "label": "現況",
  ...
  "status": {
    ...
    "defaultRoute": "預設路由",
    "noProviderYet": "還沒有 Provider",
    "quotaRemaining": "額度剩 {{percent}}%",
    "restartCodexRequired": "需重新啟動 Codex",
    "updateAvailable": "更新可用",
    "updateWaitingIdle": "已下載，等待閒置",
    "updateWaitingRestart": "已下載，下次啟動套用",
    "updateFailed": "更新失敗或已還原",
    "remedy": {
      "startProxy": "啟動 Proxy 後生效",
      "restartProxy": "重新啟動 Proxy 後生效",
      "restartCodex": "重新啟動 Codex 後會出現在模型選單"
    }
  },
  "vocabulary": {
  ...
  "review": {
    "policy": {
      "always": {
        "label": "僅使用指定模型",
        "blurb": "一律使用指定模型。該 Provider 額度耗盡時，自動審查就會停止。"
      },
      "failover": {
  ...
  "runtime": {"notice": {"codexConfigStillPointedAtVellum": "Codex 的設定仍指向 Vellum。啟動 Proxy 後重新啟動 Codex App 即可接續使用。", "codexRunning": "Codex 正在執行；請重新啟動以載入 Proxy 與模型選單", "proxyStoppedCodexRestartRequired": "Proxy 已停止並還原設定；請重新啟動 Codex 以離開舊的 Proxy／Bridge 連線", "codexRestartDetected": "已偵測到 Codex 重新啟動；Proxy 與模型選單已載入", "routesAndCatalogUpdated": "Provider 設定與模型選單已變更；重新啟動 Vellum Proxy 與 Codex 後生效", "catalogRestored": "已還原模型選單；Codex 需要重新啟動", "catalogUpdated": "模型選單已更新", "enhancedDesktopRuntimeChanged": "Enhanced Codex Runtime 設定已變更；請重新啟動 Codex 以套用", "enhancedLaunchCoreRepaired": "Codex Desktop 已更新核心，Vellum 已自動重新啟動 Proxy 並備妥新的啟動設定；請重新啟動 Codex（先前啟動：{{launchId}}）", "enhancedLaunchCoreRepairFailed": "Codex Desktop 更新後，Vellum 無法自動重新啟動 Proxy：{{reason}}。請手動重新啟動 Proxy，再重新啟動 Codex。", "remoteOfficialAccountSwitchNotFollowed": "遠端主機 {{host}} 沒有跟著切換帳號。請開啟 Remote Manager 進行配對或同步。原因：{{detail}}", "officialAccountSwitchNativePlane": "Official GPT 仍使用未修改的 Codex 核心；只要 Enhanced bridge 在運作，Vellum 的帳號切換就不會取代 Codex Desktop 的登入身分", "enhancedDesktopBridgeReady": "Codex 已重新啟動，並改走 Enhanced bridge（啟動 {{launchId}}）", "enhancedDesktopBridgeFailed": "Codex 已重新啟動，但 Enhanced bridge 失敗：{{reason}}", "enhancedDesktopRuntimeNotArmed": "Proxy 已啟動，但 Enhanced Codex 沒有生效：第三方 Provider 的對話會由原生 Codex 執行。原因：{{detail}}", "enhancedDesktopBridgeNotObserved": "Codex 已重新開啟，但沒有任何 Enhanced bridge 回報啟動 {{launchId}}；Enhanced 並未運作", "routeHotSwapped": "路由已即時切換", "slotSwitched": "{{slot}} 已切換至 {{model}}", "restartSucceeded": "Codex 已安全重新啟動；新的執行階段設定已載入", "restartNotDetected": "已送出啟動 Codex 的要求，但 5 秒內沒有偵測到 App；請手動開啟", "restartProcessStillRunning": "Codex 尚未完全結束（結束代碼 {{exitCode}}）；已取消重新啟動", "restartBlockedByActiveRequests_one": "仍有 {{count}} 個請求執行中", "restartBlockedByActiveRequests_other": "仍有 {{count}} 個請求執行中", "restartBlockedByCodexTurn_one": "Codex Desktop 有 {{count}} 個對話正在進行；現在重新啟動會遺失它還沒寫入磁碟的內容", "restartBlockedByCodexTurn_other": "Codex Desktop 有 {{count}} 個對話正在進行；現在重新啟動會遺失它們還沒寫入磁碟的內容", "restartExecutableMissing": "找不到可驗證的 Codex App 執行檔", "restartExecutableInvalid": "Codex App 執行檔不存在或不是絕對路徑", "restartUnavailableInPreview": "瀏覽器預覽不會重新啟動 Codex", "usageOAuthNotConfigured": "Vellum 尚未設定 OpenAI OAuth；OpenAI 的用量暫以 Proxy 紀錄推估", "usageProfileUnavailable_one": "{{count}} 個 OpenAI OAuth 帳號的 Codex Token 統計暫時無法讀取", "usageProfileUnavailable_other": "{{count}} 個 OpenAI OAuth 帳號的 Codex Token 統計暫時無法讀取", "webSearchDisabledMissingBraveKey": "由於尚未設定 Brave Search API 金鑰，第三方網頁搜尋已被停用。請在設定中新增金鑰以重新啟用。"}, "alerts": {"label": "執行階段警告"}},
  "settings": {
    "language": {
      "title": "語言",
    ...
    "page": {
      ...
      "review": { "title": "自動審查", "toggle": "啟用自動核准審查", "description": "由指定模型評估 Codex 提出的核准請求。此功能不變更沙箱、網路或檔案存取權限，僅調整核准決策所使用的審查模型。", "billingHelp": "額度如何計算？", "billingHelpTitle": "自動審查與 ChatGPT 額度", "billingHelpFacts": { "enabled": { "title": "自動審查開啟", "body": "Official 審查使用這裡指定的計費帳號；選擇「跟隨目前使用的帳號」時，才沿用一般 ChatGPT 帳號路由。" }, "disabled": { "title": "自動審查關閉", "body": "Vellum 不再指定審查專用帳號。Official 請求改走一般 ChatGPT 帳號路由，通常計入模型頁目前選取的帳號。" }, "pool": { "title": "額度池例外", "body": "額度池啟用且已有成員時，一般 Official 請求由額度池選擇可用帳號，因此不一定計入模型頁手動選取的帳號。" }, "native": { "title": "未由 Vellum 管理帳號", "body": "若 Vellum 沒有管理任何 ChatGPT 帳號，請求會沿用 Codex 傳入的原生登入帳號。第三方 Provider 則使用該 Provider 自己的額度。" } }, "strategyTitle": "審查模型策略", "currentLabel": "目前生效", "fallbackActive": "使用備援模型", "selectedUnavailable": "指定模型目前不可用", "provider": "指定 Provider", "model": "指定模型", "fallbackModel": "備援模型", "billingAccount": "計費帳號", "billingFollowsDefault": "跟隨目前使用的帳號", "billingAccountMissing": "帳號 {{account}} 未在本機登入。自動審查不會改用其他帳號計費，而是直接失敗；請從清單重選，或重新登入該帳號。", "savedRemotePending": "已儲存，本機 proxy 立即生效；{{count}} 台遠端主機需要到 Remote Manager 重新套用。", "rulesTitle": "自動審查規則", "willReview": "審查範圍", "willReviewValue": "需要離開沙箱、存取受限網路或受保護路徑的操作", "willNotReview": "排除範圍", "willNotReviewValue": "已由沙箱政策允許的操作", "whenRejected": "審查未通過", "whenRejectedValue": "Codex 將改用風險較低的替代方案，不執行原核准請求" },
      ...
      "errors": { "partialRefresh": "部分資料更新失敗：{{detail}}", "reviewSave": "無法儲存自動審查設定：{{detail}}", "reviewNoModelAvailable": "尚未設定任何已啟用的審查模型，請先新增或啟用一個 Provider 再切換為固定模型。", "reviewNoFallbackAvailable": "備援需要另一個不同 Provider 的已啟用審查模型，請先新增或啟用一個。", "restore": "還原失敗：{{detail}}", "drain": "無法更新是否接收新請求：{{detail}}", "restart": "無法重新啟動 Codex：{{detail}}", "rollback": "無法還原模型選單：{{detail}}", "webSearchSave": "無法儲存網頁搜尋設定：{{detail}}", "subagentSave": "無法儲存子代理設定：{{detail}}", "logExport": "無法匯出診斷紀錄：{{detail}}" }
    }
  },
  "today": {
    "title": "現況",
    "loading": "正在讀取狀態…",
    "noProvider": "還沒有 Provider",
    "noSuccessfulRequest": "還沒有成功的請求",
    ...
    "quota": {
      "tightest": "週額度剩最少的 Provider",
      "remaining": "額度剩餘",
      "noData": "目前沒有 Provider 回報額度"
    },
    "context": {
    ...
    "providers": {
      ...
      "querying": "查詢中…",
      "refresh": "重新查詢",
      "empty": "沒有要顯示的 Provider。到「設定」勾選，或到「模型」新增一家。"
    },
    "health": {
      "title": "連線品質",
  ...
  "models": {
    "title": "模型",
    "ui": {
      "catalogTitle": "設定 Codex 模型選單", "catalogHint": "先連線帳號或 Provider，再挑出要送進 Codex 模型選單的模型。", "wireUnknown": "無法自動判定，請選擇", "customProvider": "自訂 Provider", "errors": { "partialRefresh": "部分資料更新失敗：{{detail}}", "noReset": "目前沒有可用的 Reset。", "confirmReset": "確定要為 {{account}} 使用一個 Reset？這會消耗一筆 Reset 額度，且無法復原。", "resetSuccess": "OpenAI 額度已重設。", "resetCompleted": "Reset 已完成（{{code}}）。", "resetFailed": "Reset 失敗：{{detail}}", "resetLookupFailed": "Reset 查詢失敗：{{detail}}", "oauthExpired": "授權碼已過期，請重新登入。", "oauthLoginFailed": "ChatGPT 登入失敗：{{detail}}", "oauthSwitchFailed": "無法切換 ChatGPT 帳號：{{detail}}", "oauthRemoveFailed": "無法移除 ChatGPT 帳號：{{detail}}", "oauthRefreshFailed": "無法更新 ChatGPT 登入：{{detail}}", "oauthLogoutFailed": "無法登出 ChatGPT：{{detail}}", "probeFailed": "無法偵測這個端點：{{detail}}", "opencodeApiKeyRequired": "請輸入 OpenCode Zen API key。", "opencodeConnectFailed": "無法連線 OpenCode Zen：{{detail}}", "opencodeFreeAttachFailed": "OpenCode Go 已連線，但接上它的免費模型失敗：{{detail}}", "modelProbeFailed": "無法驗證 {{model}}：{{detail}}", "modelToolProbeFailed": "{{model}} 未回傳 Codex 可用的結構化工具呼叫。", "routeRefreshFailed": "無法更新 Provider 狀態：{{detail}}", "reprobeFailed": "重新偵測能力失敗：{{detail}}", "routeRemoveFailed": "無法移除 Provider：{{detail}}", "providerModelRequired": "每個 Provider 至少要保留一個模型。", "catalogRefreshFailed": "無法更新 Codex 模型選單：{{detail}}", "wireRequired": "無法自動判定 API 協定，請選擇 Responses API 或 Chat Completions。", "modelRequired": "偵測不到模型名稱，請手動填寫。", "routeAddFailed": "無法加入 Provider：{{detail}}", "grokLoginFailed": "Grok 登入失敗：{{detail}}", "grokStartFailed": "無法啟動 Grok 登入：{{detail}}", "grokCancelFailed": "無法取消 Grok 登入：{{detail}}", "grokSwitchFailed": "無法切換 Grok 帳號：{{detail}}", "grokRefreshFailed": "無法更新 Grok 帳號：{{detail}}", "grokRemoveFailed": "無法移除 Grok 帳號：{{detail}}", "detectAttention": "需補充", "detectFact": "已偵測" },
      "confirm": {
        ...
        "removeRoute": { "title": "移除 Provider", "confirmLabel": "移除 Provider", "factProvider": "Provider", "factEffect": "影響", "effectValue": "這個 Provider 與它整份模型選單都會被移除；要復原得重新加入一次。" },
      ...
      "pool": { "title": "額度池", "onHint": "池裡的帳號自動接手；每個帳號可以保留一段每週額度。", "offHint": "關閉時維持手動切換，新請求使用你選定的帳號。", "rules": "判定規則", "rulesTitle": "額度池判定規則", "rankHint": "左邊的號碼就是順序，用 ▲▼ 調整。", "availableThisWeek": "這週還可自動取用", "availablePercent": "池內這週還可自動取用 {{value}}%", "currentAndNext": "現在由 {{current}} 取用，接著是 {{next}}。", "stalled": "池內沒有可取用的帳號；不會越過閘門或使用池外帳號。", "empty": "池是空的。從下面的帳號按「加入池」才會開始自動輪替。", "using": "取用中", "next": "下一個", "standby": "待命", "outside": "未加入池", "pause": "暫停", "resume": "恢復", "add": "加入池", "remove": "移出池", "moveUp": "往前一個順位", "moveDown": "往後一個順位", "burnable": "可燒 {{value}}%", "atGate": "已到閘門", "gateRead": "閘門 {{floor}}%", "gateLabel": "{{account}} 的每週窗閘門", "gateValue": "閘門 {{floor}}%，這週剩 {{left}}%", "saveFailed": "無法儲存額度池：{{detail}}", "reason": { "paused": "已暫停", "weeklyGate": "每週窗到閘門", "fiveHour": "5 小時窗用完", "missingQuota": "額度資料不完整" }, "rule": { "gate": { "title": "閘門是保留下限", "body": "燒到每週剩餘量等於閘門就停手；以下留給你自己，100% 就完全不給自動輪替使用。" }, "fiveHour": { "title": "5 小時窗唯讀", "body": "它是上游節流；歸零時暫時輪不到，重置後自動回來。" }, "order": { "title": "順序由你決定", "body": "號碼就是輪替順序，用 ▲▼ 調整；暫時用不了的帳號會被跳過，其餘帳號的先後不變。" }, "pause": { "title": "暫停與移出", "body": "暫停保留設定但暫不使用；移出後自動輪替不會碰它。" }, "reset": { "title": "不自動花 Reset", "body": "額度池不會自動消耗 Reset；手動重設後閘門維持原值。" }, "empty": { "title": "無帳號可用", "body": "所有池內帳號受限時明確停止，不越過閘門，也不使用池外帳號。" } } },
      ...
      "fiveHour": { "start": "啟動 5h", "starting": "啟動中…", "hint": "使用這個帳號送出一筆極小的 Luna 請求，以啟動 5 小時用量視窗。會消耗少量額度，但不會使用 Reset。", "success": "已觸發 5 小時視窗並重新讀取用量。", "failed": "無法觸發 5 小時視窗：{{detail}}", "refreshFailed": "觸發請求已完成，但無法重新讀取用量：{{detail}}", "autoOn": "5h 自動：開", "autoOff": "5h 自動：關", "autoHint": "依目前額度與 resetAt 自動續接 5 小時視窗。只有舊視窗已到期且每週額度仍高於閘門時，才用 Luna、最低 effort 送出一筆極小請求；判斷會寫入可匯出的 Vellum log。" },
      "grok": { "title": "Grok 帳號", "description": "Grok Build 的新請求會使用目前帳號。切換立刻生效，進行中的請求不會中途更換帳號。", "loginStatus": "登入狀態", "browserHint": "官方 Grok CLI 已啟動登入流程；完成授權後會自動加入帳號。", "loginIncomplete": "官方登入流程尚未完成。", "defaultAccount": "Grok CLI 預設帳號", "externalCli": "外部 CLI", "managed": "Vellum 管理", "reauthenticate": "重新驗證", "refreshModels": "重新偵測 Grok 模型", "unlink": "解除連結", "empty": "目前沒有可用的 Grok 帳號。", "add": "新增 Grok 帳號" },
      "opencode": { "title": "OpenCode Zen", "description": "只要填入 API key 就能連線。這裡預設跟 OpenCode 官方 App 一樣，只顯示免費模型。付費 Zen 模型需要購買額度，而這個連線無法查證，如果你確實有購買，請改用下方手動加入 Provider 的流程。", "descriptionGo": "只要填入 API key 就能連線。OpenCode Go 是另一個端點上獨立的小型模型庫，不含 OpenCode Zen 的 GPT／Claude／Gemini 等進階模型；如果你的 key 屬於 Go 訂閱，就選這個。Go 的端點不接受免費模型，所以 Vellum 會另外把 OpenCode Zen 的免費模型接成第二個 Provider。", "freeRouteName": "{{name}}（免費模型）", "catalog": "模型庫", "catalogZen": "OpenCode Zen（免費模型）", "catalogGo": "OpenCode Go", "catalogHint": "請選擇你實際擁有的方案。Zen 只連線免費模型；Go 連線 Go 方案的模型庫，並自動附帶同樣的免費模型。", "apiKey": "OpenCode Zen API key", "apiKeyPlaceholder": "貼上 OpenCode Zen API key", "connect": "連線", "connecting": "連線中…", "connected": "已連線" },
      "addProvider": { "title": "加入 Provider", "steps": { "endpoint": "連接端點", "endpointHint": "取得 Provider 提供的模型清單。", "probe": "選擇並驗證模型", "probeHint": "先選擇要匯入的模型，再針對該模型驗證 Codex 協定能力。", "add": "加入", "addHint": "確認結果並加入 Codex 模型選單。" }, "endpoint": "端點網址", "apiKey": "API key（選填，加密存放）", "apiKeyPlaceholder": "本機或用帳號登入的端點可留空", "startProbe": "取得模型清單", "probing": "正在取得模型清單…", "add": "加入 Provider", "reprobe": "重新設定" },
      "probe": { "reachable": "可以連上", "wire": "API 協定", "modelCount": "偵測到 {{count}} 個模型", "modelsMissing": "偵測不到，請手動填寫", "context": "上下文視窗", "required": "需要填寫", "streaming": "串流", "supported": "支援", "unsupported": "不支援", "toolCalling": "Codex 工具協定", "typedToolCalls": "已驗證結構化工具呼叫", "toolCallingUnavailable": "未通過驗證", "chatOnly": "僅支援對話，無結構化工具呼叫", "reasoning": "推理內容", "detected": "已偵測", "notDetected": "未偵測到", "serverResume": "上游記住對話", "remembers": "會記住", "localHistory": "不記住，由 Vellum 補歷史", "detectedModels": "偵測到的模型", "selectionHint": "只有已勾選且通過驗證的模型會加入 Codex 模型選單。", "verifyToImport": "勾選以驗證工具呼叫", "verificationRequired": "需要進行能力驗證", "timeout": "偵測逾時", "unknown": "未知", "verifyModel": "驗證", "verifyingModel": "驗證中…",  "quotaWithRetry": "額度限制（HTTP 429 · 請於 {{seconds}} 秒後重試）", "unauthorized": "認證失敗（HTTP 401/403）", "protocolError": "協定格式錯誤", "toolCallMissing": "未產生結構化工具呼叫", "unsupportedOpenCodeProtocol": "目前尚未支援 Anthropic／Google 原生協定", "defaultModel": "預設模型", "defaultModelHint": "所有模型都會加入 Codex 選單；這裡只決定 Provider 建立後預先選用哪一個。", "select": "請選擇", "wireHint": "這是 Provider 接收請求的 API 協定，不是回應的 JSON 格式。", "manualPlaceholder": "偵測不到，請手動填寫", "settingsTitle": "端點偵測設定", "requestSize": "請求大小", "preferredWire": "優先 API 格式", "preferredWireValue": "先試 Responses，再退回 Chat Completions", "contextSource": "上下文長度來源", "contextSourceValue": "依序採用手動設定、端點回報、模型快取與 Codex 模型選單。", "history": "對話歷史保存", "historyValue": "當上游不提供工作階段續接時，由本機加密保存對話歷史。" },
      "modelCatalog": { "rename": "改名", "renameProvider": "Provider 顯示名稱", "renameModel": "模型顯示名稱", "renameHint": "只改顯示名稱。送給 Provider 的仍是上游 id，Codex 既有的路由也不受影響。", "allowPrivateNetworkHttp": "允許明文 HTTP 連到私有網路", "allowPrivateNetworkHttpHint": "給區網或 Tailscale 之類的位址用的：預設拒絕明文 HTTP 連到非本機端點，開啟後才能連到私有網路（LAN、CGNAT、Tailscale）位址；仍然拒絕連到公開網際網路。", "renameModelPlaceholder": "留空就顯示上游 id", "renameSave": "儲存", "renameCancel": "取消", "free": "免費", "deprecated": "已下架", "vision": "圖片", "visionOn": "這個模型可接受圖片輸入", "visionOff": "這個模型只吃文字；勾選後 Codex 才會開放附圖", "visionHint": "圖片支援沒辦法可靠地偵測——純文字的端點收到圖片照樣回 200，然後讓模型自己編答案。請依模型實際支援的能力勾選。", "tokenUnit": "token", "effort": "推理強度", "responses": "Responses", "chat": "Chat Completions", "title": "模型選單", "hint": "已勾選的模型將加入 Codex 模型選單。", "empty": "還沒有 Provider。用上面的流程加入第一家。", "countSelected": "{{selected}} / {{total}} 個", "count": "{{count}} 個", "unknownWindow": "視窗未知", "reasoning": "推理", "noReasoning": "無推理", "auto": "自動", "capabilityMissing": "尚未取得此 Provider 的模型能力資料。", "recent": "最近使用", "reprobe": "重新偵測能力", "reprobeInProgress": "正在驗證 {{count}} 個已選模型…", "reprobeSummary": "已驗證 {{succeeded}}/{{targeted}} 個已選模型", "reprobeSummaryWithFailures": "已驗證 {{succeeded}}/{{targeted}} 個已選模型，{{failed}} 個失敗", "effortNotProbed": "尚未偵測", "effortUnverified": "無法驗證", "effortReasonIgnored": "Provider 對刻意送出的無效推理強度也回傳成功，因此無法證明 low／medium／high 等層級真的生效。重複偵測通常不會改變結果。", "effortReasonQuota": "推理強度偵測被 Provider 額度或帳號權限擋下{{detail}}", "effortReasonProvider": "推理強度偵測期間發生 Provider 錯誤、逾時或回應不完整{{detail}}", "effortReasonUnknown": "這次推理強度偵測沒有取得足以判斷支援層級的證據{{detail}}", "retryEffortProbe": "重試推理強度偵測", "footerNote": "啟用與停用會立刻存檔，但要重新啟動 Proxy 才會生效；模型選單則要重新啟動 Codex 才會重讀。兩者都還沒完成前，狀態會顯示「待生效」。", "windowEdit": "設定最大上下文長度", "windowHint": "設定這個模型的最大上下文長度", "windowAuto": "自動", "windowManual": "這是你手動設定的值；清空後就改回偵測到的值。", "windowUnavailable": "這個模型還沒進 Codex 選單，沒有地方可以設。", "windowInvalid": "最大上下文長度要填大於 0 的數字，留空則改回自動。", "windowSaveFailed": "最大上下文長度存不進去：{{detail}}" }
    }
  },
  "context": {
    ...
    "transcript": {
      "eyebrow": "壓縮紀錄",
      "title": "壓縮指令與替換內容",
      "hint": "顯示送給模型的壓縮指令，以及模型回傳的替換內容。之後的回合會沿用這段替換內容。",
      "chars": "{{value}} 字",
      "prompt": "送出的指示",
      "promptNote": "壓縮提示詞，與模型實際收到的內容一致。",
      "result": "寫回來的內容",
      "resultNote": "後續對話會一直帶著的內容。",
    ...
    "footerNote": "壓縮由執行該對話的 Codex runtime 負責；Vellum 只顯示觀察到的事件，舊版 journal 僅供唯讀查閱。",
    "segmentAria": {
  ...
  "remote": {
    ...
    "act": {
      ...
      "replan": "更新預覽",
      "apply": "確認並同步",
      "restartNative": "重新啟動遠端 Codex daemon",
    ...
    "chore": {
      ...
      "takeoverNative": "Codex App 目前直接佔用此主機的 daemon。接管後將改用 Vellum 管理的 native daemon，進行中的工作可能被中斷。",
      ...
      "syncDesktopCodex": "安裝與此 Desktop core 完全一致的官方 Linux Codex build，通過協定驗證後重新啟動遠端 daemon。Desktop {{desktop}}；遠端 {{remote}}。",
    ...
    "confirm": {
      ...
      "takeoverNative": {
        "changes": "將 Codex App 直接佔用的 app-server 更換為 Vellum 管理的 native daemon。",
      ...
      "installCodex": {
        ...
        "turns": "不會停止進行中的 turn；新版本會在 daemon 重新啟動後生效。"
      },
      "updateAgent": {
        "changes": "把 vellum-remote-agent 更新到目前 Vellum 內嵌的版本，並驗證 digest。",
        "untouched": "Broker、Proxy image 與 Codex CLI 都不在這一步更新。",
        "turns": "Agent 會自行重新啟動，遠端操作會短暫中斷。"
      },
      "syncDesktopCodex": {
        "changes": "下載與 Desktop core 完全一致的 OpenAI 官方 Linux artifact、驗證發布者 digest、偵測 app-server 協定、原子安裝並重新啟動遠端 daemon。",
        "untouched": "Vellum Proxy image、模型選單、帳號、專案與既有的 task。",
        "turns": "遠端 daemon 重新啟動時，進行中的 turn 可能中斷。"
      },
      "stopAppOwned": {
        "changes": "安全停止 Codex App 直接佔用的 app-server，然後重新執行部署。",
        "untouched": "設定檔、模型選單與已登入的帳號。",
    ...
    "blocker": {
      ...
      "codexRestartRequired": "設定已寫入，但要重新啟動後才會生效。",
      ...
      "insufficientDiskSpace": "可用空間不足以容納下載、解壓與回滾保留，替換作業已停止。不會自動刪除使用者資料。",
      "incompleteObservation": "無法完整觀察受管理 runtime 的 turn、工具或核准，已擋下破壞性操作。",
    ...
    "phase": {
      ...
      "applying": "套用部署計畫",
      "verification": "驗證 Proxy、daemon 與脫離準備狀態",
      "verified": "已就緒",
      "restorePreflight": "檢查進行中的 turn 與受管理狀態",
      "restoreLease": "還原 Codex 設定與模型選單",
      "restartNative": "用還原後的設定重新啟動 native Codex",
    ...
    "error": {
      "discovery": "讀取連線設定失敗。",
      "desktopCodexMismatch": "遠端 Codex runtime 與目前 Desktop 協定不相容。請先同步 Desktop Codex runtime，再重試一次。",
    ...
    "desktopCodex": {
      ...
      "states": {
        ...
        "qualificationRequired": "需要重新驗證協定",
    ...
    "sessions": {
      ...
      "turns_one": "{{count}} 個 turn · 最近一次 {{last}}",
      "turns_other": "{{count}} 個 turn · 最近一次 {{last}}",
      "observability": {
        "nativeAppServer": "可觀察",
        "unsupported": "不支援",
  ...
  "onboarding": {
    ...
    "ui": { "providerSeparator": "、", "back": "回上一幕", "skipHint": "一家都沒接也可以先過，之後在「模型」頁加。", "skip": "先跳過", "continue": "繼續", "enter": "進入 Vellum", "enterWithoutProxy": "先不啟動，直接進去", "start": "開始", "skipSetup": "我設定過了，直接進去", "unwritten": "第 {{step}} 幕，尚未進行", "visited": "（已讀過，可回去）", "login": "登入", "collapse": "收起", "fillEndpoint": "填端點", "connected": "已接上", "unavailable": "不可用", "waitingAuth": "等待授權", "notConnected": "未連線", "waitingAuthEllipsis": "等待授權…", "addAnother": "再接一個", "enterCode": "在瀏覽器輸入這組代碼", "providerType": "Provider 類型", "customEndpoint": "自訂 API 端點", "opencodeHint": "OpenCode Zen 使用官方固定端點。只需輸入 API key，Vellum 會取得並驗證相容模型。", "opencodeApiKey": "OpenCode Zen API key", "opencodeApiKeyPlaceholder": "貼上 OpenCode Zen API key", "displayName": "顯示名稱", "displayNamePlaceholder": "例如 自架 vLLM", "endpoint": "端點", "optionalPlaceholder": "不需要就留空", "endpointHint": "留空代表這個端點不驗證。", "probing": "偵測中…", "probeAndAdd": "偵測並加入", "notConnectedYet": "尚未接上" },
    "overture": { "lead": "刮掉，重寫。", "history": "中世紀的犢皮紙很昂貴，寫滿後會刮掉重寫，而刮不乾淨的舊字跡仍會從底下透出來。", "mission": "這個程式做的是同一件事：上下文滿了不截斷，重寫一次，該留的留著。", "subtitle": "一個只跑在你機器上的 Codex 代理 · 接下來四幕，都寫在這一張紙上" },
    "what": { "axisTargets": "ChatGPT ／ Grok ／ 自訂", "title": "它站在中間", "lead": "Codex 照常打原本的端點。Vellum 在中間把請求轉給你選的 Provider——換 Provider、換模型、調整上下文，都不必動到 Codex 設定檔。", "axisAria": "Codex CLI 經由本機 Vellum Proxy 連到 ChatGPT、Grok 或自訂端點", "client": "你在用的", "local": "本機 · 不外送", "answering": "實際回答的", "noConfigTitle": "不動設定檔", "noConfigBody": "啟動時接管 Codex 端點，停止時原樣還原。不必手改 config，也不會留下改到一半的狀態。", "noTruncateTitle": "不做硬性截斷", "noTruncateBody": "接近門檻時，會先把對話整理成包含目標、已完成事項與下一步的檢查點，再繼續往下走，而不是砍掉前面的歷史。", "reviewTitle": "核准可以換人判斷", "reviewBody": "原本要你按 y/n 的操作，可以指定由另一個模型評估。沙箱、網路與檔案權限完全不變。", "privacy": "全部在這台機器上。Vellum 沒有伺服器，你的對話不會經過我們；憑證加密後存在本機。" },
    "connect": { "title": "接上一家", "lead": "一家就夠開始。之後可以再加，也可以同時開著好幾家——不同工作階段走不同 Provider，額度快用完的那家會先被看見。", "chatgptClaim": "用你原本的訂閱額度", "chatgptDetail": "走官方裝置碼登入，不需要 API key。訂閱內的 Reset 額度也會帶進來，之後可在「模型」頁使用。", "grokClaim": "走官方 CLI 的登入流程", "grokDetail": "需要這台機器已裝好 Grok CLI。登入後可以掛多個帳號，額度分別計算。", "grokUnavailable": "尚未安裝 Grok CLI，或目前無法偵測。", "customName": "自訂端點", "customClaim": "任何 OpenAI 相容的服務", "customDetail": "填端點與 API key，Vellum 會自動偵測可用的模型與上下文長度。自架、代理、第三方服務都走這條。", "codexToolProtocolUnavailable": "端點可以連線，但沒有模型回傳 Codex 可執行的結構化工具呼叫。請先在 vLLM、Ollama 或 llama.cpp 設定好工具呼叫，再加入 Codex。", "credentialNote": "憑證用系統金鑰鏈加密後存在本機，不會寫進 Codex 設定檔，也不會出現在紀錄裡。" },
    "features": { "title": "這些已經開著", "lead": "不需要額外設定就會生效。這一幕只讓你知道它們在哪裡，以及之後要去哪一頁修改。", "reviewTerm": "自動審查\n可以換模型", "settingsPage": "設定", "reviewBody": "Codex 要求核准的操作交給指定 Provider 與模型評估，也可以設定備援。主力額度用完時會標示備援中，不會安靜換人。", "resetTerm": "Reset 額度\n直接在這裡用", "modelsPage": "模型", "resetBody": "ChatGPT 帳號的 Reset 額度直接寫在帳號那一列，按下去消耗一筆，用完立刻重新查。", "sessionTerm": "每個視窗\n各算各的", "todayPage": "現況", "sessionBody": "同時開好幾個 Codex 視窗時，每個視窗有自己的對話與上下文視窗。現況頁會優先顯示最接近壓縮門檻的那一個，而不是平均成一個數字。" },
    "launch": { "title": "把 Codex 接過來", "runningTitle": "已經走 Vellum 了", "lead": "啟動後 Vellum 會接管 Codex 端點設定，停止時原樣還原。這個動作可以隨時撤回。", "runningLead": "端點已經接管，請求會轉給你接上的 Provider。停止時會回到安裝 Vellum 之前的設定。", "startProxy": "啟動 Proxy", "noProviderHint": "一家都還沒接上——可以先啟動，但要等接上後才會有模型回答。", "connectedProviders": "接上的 Provider", "howToStart": "怎麼開始用", "howToStartValue": "開一個新的 Codex 視窗。已經開著的要重新啟動才會走 Vellum。", "howToStop": "怎麼停", "howToStopValue": "在「現況」頁按「停止 Proxy 並還原 Codex」", "reopenGuide": "重看這份導覽", "reopenGuideValue": "「設定」頁" }
  }
};
