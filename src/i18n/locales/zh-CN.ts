...
const zhCN: ResourceTree = {
  ...
  "models": {
    ...
    "ui": {
      ...
      "fiveHour": { "start": "启动 5h", "starting": "启动中…", "hint": "使用这个账号发送一笔极小的 Luna 请求，以启动 5 小时用量窗口。会消耗少量额度，但不会使用 Reset。", "success": "已触发 5 小时窗口并刷新用量。", "failed": "无法触发 5 小时窗口：{{detail}}", "refreshFailed": "触发请求已完成，但无法刷新用量：{{detail}}" },
