...
const zhCN: ResourceTree = {
  "enhanced": {"heading":"Enhanced 运行状态","lead":"显示每条路由的执行归属、兼容性检查结果，以及手机连接状态。","title":"Enhanced Core","subtitle":"执行归属、兼容性证据与手机连接","serving":"Enhanced Core 正在服务","notServing":"Enhanced Core 尚未服务","sessions":"已观测会话","running":"运行中回合","freshness":"观测状态","restartRequired":"已准备新的启动组合。请在活动回合结束后安全重启。","launchCoreDrift":"Codex Desktop 已更新内核。Vellum 会在回合空闲时自动重启 Proxy；完成后请重启 Codex。","now": "现在", "runningTurns_one": "{{count}} 个回合执行中", "runningTurns_other": "{{count}} 个回合执行中", "sessionCount_one": "{{count}} 个会话", "sessionCount_other": "{{count}} 个会话", "verdict": {"serving": "Codex Desktop 正在通过 Enhanced Core 执行。", "servingOtherLaunch": "Enhanced 正在服务，但使用的是上一次启动的配置。重启 Codex 后才会应用当前配置。", "stoppedAt": "启动流程在「{{link}}」阶段停止。", "disabled": "Enhanced Core 已停用，Codex Desktop 正在使用原生内核。"}, "chain": {"title": "启动流程", "artifact": "组件验证", "armed": "路径接管", "adopted": "Bridge 对接", "inPlace": "运行确认"}, "mark": {"blocked": "未通过", "waiting": "等待中", "inPlace": "已生效"}, "whyStopped": "「{{link}}」阶段停止的原因", "whyNoted": "正在运行，但存在需要注意的项目", "protocol": {"verified": "已验证", "unverified": "未验证", "incompatible": "不兼容"}, "protocolUnrun": "比对尚未执行", "unverifiedNote": "此 Codex Desktop 版本未通过验证。路由所需的方法均存在，因此路由可用；列出的差异未经测试，正确性不保证。", "missingHelpers": "Enhanced 内核缺少官方安装提供的辅助程序：{{list}}。对话与路由不受影响，沙箱命令执行会失败。", "routed": "路由所需", "delta": {"methodUnservable": "此方法无法提供", "methodUnknownToDesktop": "Desktop 未声明此方法", "fieldNewlyRequired": "新增必填字段", "fieldRemoved": "字段已移除"}, "environment": {"leased": "已接管", "released": "未接管", "orphanedBridge": "残留旧 bridge", "foreignValue": "由其他工具设置", "unreadable": "无法读取"}, "bridgeProcess": "Bridge 进程", "bridgeState": "Bridge 状态", "children": "子进程", "launch": "启动", "relayNote": "手机连接需通过握手、任务列表、消息加载、实时事件与任务控制五个阶段；未完成的阶段即为连接失败原因。", "staleWarning":"当前显示最后一次观测，数据可能已过期。","compatibility":"版本与兼容性","activeRuntime":"当前使用的 runtime","candidateRuntime":"下次启动使用的 runtime","structure":"Schema 比较","qualification":"最近验证","notObserved":"未观测","observed":"已观测","evidenceNote":"Schema 相同仅代表结构证据，不能证明 Desktop 或手机功能已通过实机验证。","differences":"差异与阻止原因","relay":"Relay 状态","clients":"已连接客户端版本","handshake":"握手","list":"任务列表","history":"消息加载","stream":"实时事件","control":"任务控制","failureStage":"最近失败阶段","plane":"执行归属","all":"全部","empty":"此次启动尚无会话观测。历史绑定不等于当前连接。","session":"会话","state":"状态","lastActivity":"最后活动","parent":"父任务","diagnostics":"诊断","recheck":"重新检查兼容性","export":"导出诊断","exported":"已保存","states":{"starting":"启动中", "ready":"就绪", "degraded":"降级", "stopped":"已停止", "transportReady":"传输就绪", "unknown":"未知","current":"最新","stale":"已过期","offline":"离线","unavailable":"无观测数据","running":"运行中","idle":"空闲","approval":"等待批准","unloaded":"已卸载","observed":"已观测","attached":"已附加","failed":"失败"}},
  "common": { "expiresAt": "到期时间：{{month}} 月 {{day}} 日 {{time}}（{{zone}}）", "expiredAlready": "已过期", "expiresInMinutes": "剩 {{value}} 分钟", "expiresInHours": "剩 {{value}} 小时", "expiresInDays": "剩 {{value}} 天","emDash": "—", "none": "—", "listSeparator": "；", "itemSeparator": "、", "loading": "读取中…", "processing": "处理中…", "refreshing": "更新中…", "refresh": "刷新", "reorganize": "重新整理", "save": "保存", "cancel": "取消", "confirm": "确认", "close": "关闭", "remove": "移除", "enabled": "启用", "disabled": "停用", "yes": "是", "no": "否", "on": "开", "off": "关", "unknown": "未知", "provider": "供应商", "model": "模型", "proxy": "Proxy", "codexCatalog": "Codex 模型菜单", "justNow": "刚刚", "minutesAgo": "{{count}} 分钟前", "hoursAgo": "{{count}} 小时前", "daysAgo": "{{count}} 天前", "resetAt": "{{month}} 月 {{day}} 日 {{time}} 重置", "previousPage": "上一页", "nextPage": "下一页", "pageOf": "第 {{page}} / {{total}} 页", "shortcutTitle": "{{label}}（Ctrl+{{n}}）", "statusUpdateFailed": "状态更新失败：{{detail}}", "errorWithDetail": "{{message}}：{{detail}}", "connectionFailed": "连接失败", "operationFailed": "操作失败", "loadFailed": "加载失败", "saveFailed": "保存失败", "visible": "显示", "hidden": "隐藏", "totalItems_one": "共 {{count}} 条", "totalItems_other": "共 {{count}} 条", "itemsNeedAttention_one": "个项目需要处理", "itemsNeedAttention_other": "个项目需要处理", "notice": {"info": "说明", "warn": "注意", "error": "失败"}, "dismiss": "知道了"},
  "navigation": {
    "mainAria": "主导航",
    "today": {
      "label": "现状",
  ...
  "review": {
    "policy": {
      "always": {
        "label": "仅使用指定模型",
        "blurb": "所有审查均使用指定模型。该模型不可用或额度耗尽时，自动审查将停止并报告错误。"
      },
      "failover": {
  ...
  "runtime": {"notice": {"codexConfigStillPointedAtVellum": "Codex 的配置仍指向 Vellum。启动 Proxy 后重新启动 Codex App 即可继续使用。", "codexRunning": "Codex 正在运行；请重新启动以载入 Proxy 与模型菜单", "proxyStoppedCodexRestartRequired": "Proxy 已停止并还原设置；请重新启动 Codex 以离开旧的 Proxy／Bridge 连接", "codexRestartDetected": "已检测到 Codex 重新启动；Proxy 与模型菜单已载入", "routesAndCatalogUpdated": "线路设置与模型菜单已更新；重新启动 Vellum Proxy 与 Codex 后生效", "catalogRestored": "已回复模型菜单；Codex 需要重新启动", "catalogUpdated": "模型菜单已更新", "enhancedDesktopRuntimeChanged": "Enhanced Codex Runtime 设置已更改；请重启 Codex 以应用", "enhancedLaunchCoreRepaired": "Codex Desktop 已更新内核，Vellum 已自动重启 Proxy 并准备新的启动设置；请重启 Codex（原启动 {{launchId}}）", "enhancedLaunchCoreRepairFailed": "Codex Desktop 更新后，Vellum 无法自动重启 Proxy：{{reason}}。请手动重启 Proxy，再重启 Codex。", "remoteOfficialAccountSwitchNotFollowed": "远程主机 {{host}} 没有跟着切换账号。请到 Remote Manager 配对或对齐。原因：{{detail}}", "officialAccountSwitchNativePlane": "Official GPT 仍走未修改的 Codex 核心；Enhanced bridge 启用时，Vellum 账号切换不会取代 Codex Desktop 的登录账号", "enhancedDesktopBridgeReady": "Codex 已重新启动，且走的是 Enhanced bridge（启动 {{launchId}}）", "enhancedDesktopBridgeFailed": "Codex 已重新启动，但 Enhanced bridge 失败：{{reason}}", "enhancedDesktopRuntimeNotArmed": "Proxy 已启动，但 Enhanced Codex 没有武装：第三方 Provider 的对话会由原生 Codex 执行。原因：{{detail}}", "enhancedDesktopBridgeNotObserved": "Codex 已重新打开，但启动 {{launchId}} 没有任何 Enhanced bridge 回报；Enhanced 没有在跑", "routeHotSwapped": "路由已热切换", "slotSwitched": "{{slot}} 已切换至 {{model}}", "restartSucceeded": "Codex 已安全重新启动；新的运行期设置已载入", "restartNotDetected": "已送出 Codex 启动请求，但 5 秒内未检测到 App；请手动打开 Codex", "restartProcessStillRunning": "Codex 尚未完全关闭（停止代码 {{exitCode}}）；已取消重新启动", "restartBlockedByActiveRequests_one": "仍有 {{count}} 个请求执行中", "restartBlockedByActiveRequests_other": "仍有 {{count}} 个请求执行中", "restartBlockedByCodexTurn_one": "Codex Desktop 有 {{count}} 个对话正在进行；现在重启会丢掉它还没写进硬盘的内容", "restartBlockedByCodexTurn_other": "Codex Desktop 有 {{count}} 个对话正在进行；现在重启会丢掉它们还没写进硬盘的内容", "restartExecutableMissing": "找不到可验证的 Codex App 执行文件", "restartExecutableInvalid": "Codex App 执行文件不存在或不是绝对路径", "restartUnavailableInPreview": "浏览器预览不会重新启动 Codex", "usageOAuthNotConfigured": "尚未在 Vellum 配置 OpenAI OAuth；OpenAI 暂以 Proxy 记录估算", "usageProfileUnavailable_one": "{{count}} 个 OpenAI OAuth 账号的 Codex Token 统计暂时无法读取", "usageProfileUnavailable_other": "{{count}} 个 OpenAI OAuth 账号的 Codex Token 统计暂时无法读取", "webSearchDisabledMissingBraveKey": "由于未设置 Brave Search API 密钥，第三方网页搜索已被停用。请在设置中添加密钥以重新启用。"}, "alerts": {"label": "运行阶段警告"}},
  "settings": {
    "language": {
      "title": "语言",
    ...
    "title": "设置",
    "page": {
      "subagent": { "title": "子代理默认设置", "description": "默认情况下，子代理使用发起它那次对话的模型与推理强度。这里可以改成固定的默认值；任务若明确指定模型或 Effort，仍以任务指定为优先。", "desktopReady": "Codex Desktop 已就绪", "desktopUnavailable": "Codex Desktop 无法应用此设置", "desktopVersion": "Desktop 版本 {{version}} · 原生子代理默认设置可用", "defaultsTitle": "未指定时使用的模型", "mode": { "inherit": "保留 Desktop 现有设置", "custom": "由 Vellum 指定默认" }, "effort": "推理强度", "autoEffort": "自动（模型默认）", "effortNotProbed": "此模型的推理强度尚未验证；请先到 Models 页面探测能力。", "modelEmpty": "此 Provider 目前没有可选的模型。", "hint": "这些只是默认值；代理可依任务明确指定其他已启用模型与 Effort。", "unavailable": "所选的 Provider 或模型目前已不可用。依赖此默认值建立的子代理会明确失败，直到更新设置。", "unsupported": "无法验证 Codex Desktop 的原生子代理设置：{{detail}}" },
      "loading": "正在加载设置…", "heading": "审查、搜索、显示与系统恢复", "unspecified": "未指定", "saved": "设置已保存",
      "review": { "title": "自动审查", "toggle": "启用自动批准审查", "description": "由指定模型评估 Codex 提出的批准请求。本功能不改变沙箱、网络或文件访问权限，仅调整批准决策所使用的审查模型。", "billingHelp": "额度如何计算？", "billingHelpTitle": "自动审查与 ChatGPT 额度", "billingHelpFacts": { "enabled": { "title": "自动审查开启", "body": "Official 审查使用此处指定的计费帐号；选择“跟随当前使用的帐号”时，才沿用一般 ChatGPT 帐号路由。" }, "disabled": { "title": "自动审查关闭", "body": "Vellum 不再指定审查专用帐号。Official 请求改走一般 ChatGPT 帐号路由，通常计入模型页当前选择的帐号。" }, "pool": { "title": "额度池例外", "body": "额度池启用且已有成员时，一般 Official 请求由额度池选择可用帐号，因此不一定计入模型页手动选择的帐号。" }, "native": { "title": "未由 Vellum 管理帐号", "body": "若 Vellum 没有管理任何 ChatGPT 帐号，请求会沿用 Codex 传入的原生登录帐号。第三方 Provider 则使用该 Provider 自己的额度。" } }, "strategyTitle": "审查模型策略", "currentLabel": "当前生效", "fallbackActive": "使用备援模型", "selectedUnavailable": "指定模型当前不可用", "provider": "指定 Provider", "model": "指定模型", "fallbackModel": "备援模型", "billingAccount": "计费帐号", "billingFollowsDefault": "跟随当前使用的帐号", "billingAccountMissing": "帐号 {{account}} 未在本机登录。自动审查不会改用其他帐号计费，而是直接失败；请从列表重选，或重新登录该帐号。", "savedRemotePending": "已保存，本机 proxy 立即生效；{{count}} 台远程主机需要到 Remote Manager 重新应用。", "rulesTitle": "自动审查规则", "willReview": "审查范围", "willReviewValue": "需要离开沙箱、访问受限网络或受保护路径的操作", "willNotReview": "排除范围", "willNotReviewValue": "已由沙箱策略允许的操作", "whenRejected": "审查未通过", "whenRejectedValue": "Codex 将改用风险较低的替代方案，不执行原批准请求" },
      "stats": { "title": "各 Provider 审查次数", "summary": "备援 {{fallback}} / {{total}} 次（{{percent}}%）", "primary": "指定", "fallback": "备援", "failed": "失败", "lastUsed": "最后使用时间", "neverUsed": "暂无记录", "empty": "自动审查当前暂无执行记录。Codex 下一次提出批准请求后，系统将记录实际使用的 Provider。" },
      ...
      "dashboard": { "title": "仪表板 Provider 显示设置", "note": "已选择 {{count}} 家。只影响现状页显示，不会启用或停用任何供应商。", "disabledVisible": "显示（已停用）" },
      "restore": { "title": "恢复 Codex 原始设置", "description": "移除 Vellum 写入 Codex 的供应商设置、代理网址和模型菜单项目。登录凭证、聊天记录、项目分组和工作区数据不会改变。", "action": "恢复 Codex 原始设置", "cleared": "已恢复", "result": "结果", "nothingToClear": "Codex 中没有 Vellum 写入的设置，不需要恢复", "preserved": "未修改：{{items}}。" },
      "enhancedRuntime": {"title": "Enhanced Codex Runtime", "description": "第三方 Provider 的新对话改由 Enhanced Codex 执行；OpenAI 官方模型保持原生 Codex Runtime。切换执行平面必须新建对话。", "desiredState": "要求状态", "desiredEnabled": "要求启用", "desiredDisabled": "要求停用", "activation": {"disabled": "未启用", "artifactBlocked": "可执行文件验证失败", "awaitingDesktopRestart": "等待重新启动 Codex Desktop", "active": "已生效", "disablePendingRestart": "已要求停用，等待重新启动", "environmentDrift": "接管状态不一致", "failed": "Bridge 启动失败"}, "environment": {"leased": "Vellum 已安全接管", "released": "尚未接管", "orphanedBridge": "残留旧版 Vellum bridge", "foreignValue": "由其他工具设置，Vellum 没有覆盖", "unreadable": "无法读取用户环境变量"}, "environmentValue": "CODEX_CLI_PATH 当前的值", "environmentUnset": "尚未设置", "staleBridge": "这条路径是旧版 Vellum 留下的 bridge，不是这个构建要用的那一个。按「停用并释放接管」清掉它，再重新启用。", "launchDetail": "{{launchId}} · {{state}} · bridge {{bridgePid}} · Official {{officialPid}} · Enhanced {{enhancedPid}}", "officialBinary": "官方 Codex core", "officialBinaryHint": "从已安装的 Codex Desktop 检测。必须与 Desktop 实际执行的那一个相同，因此不开放更改。", "enhancedBinary": "Enhanced Codex core", "bridgeBinary": "App Server bridge", "bridgeBinaryHint": "随这个 Vellum 构建一起提供，哈希写死在程序里，不能换成别的文件。", "protocol": {"label": "协议检测", "unavailable": "无法检测", "details": "差异与诊断（{{count}}）", "routed": "路由", "verdict": {"verified": "与锁定版本一致", "unverified": "可用，但不保证正确性", "incompatible": "不兼容，已回退"}, "mean": {"verified": "这正是这个 Vellum 版本锁定的组合，两边的协议逐字节相同。", "unverified": "这个 Codex Desktop 版本没有人验证过。bridge 分派要用到的方法都还在，所以路由没问题；下面列的差异是真实存在的，只是没被测过。", "incompatible": "Codex Desktop 改动了 bridge 分派时必须用到的方法，没有可以降级的跑法。"}, "delta": {"shapeIncompatible": "{{subject}} 的 wire 形状对方不接受：{{fields}}", "shapeUnverified": "{{subject}} 的 wire 形状无法判定：{{fields}}", "methodUnservable": "Desktop 可能调用 {{subject}}，Enhanced core 没有实现", "methodUnknownToDesktop": "Enhanced core 可能发出 {{subject}}，Desktop 已不再声明", "fieldNewlyRequired": "Desktop 现在要求 {{subject}} 的 {{fields}}，Enhanced core 不会发出", "fieldRemoved": "Desktop 不再发出 {{subject}} 的 {{fields}}，Enhanced core 会读它"}, "fallback": "已回到原生 Codex。Codex 本身照常运行，只是 Enhanced 的功能都不在。"}, "protocolHash": "App Server 协议", "observedBridge": "实际运行中的 bridge", "unverified": "尚未验证", "details": "技术细节与排查资料", "runInstalledGate": "重新执行安装版验证", "installedGateHint": "比重开一次更深的验证：重新启动 Codex Desktop，跑完整组安装版 gate 并留下报告。", "lastQualification": "上次验证", "qualificationPassed": "{{mode}} 通过，可以升级", "qualificationComponentOnly": "{{mode}} 组件测试通过，但尚未达到实机升级门槛", "qualificationFailed": "{{mode}} 未通过 —— {{detail}}", "qualificationReport": "报告", "planeTitle": "每条路由现在走哪一边", "contextNote": "压缩由执行对话的 runtime 自己负责：官方路径用 Official Codex 原生压缩，第三方路径用 Enhanced Codex 的本机压缩与上下文恢复。Vellum 不再另外套用压缩策略。", "planeOfficial": "Official Codex · 原生压缩", "planeEnhanced": "Enhanced Codex · 本机压缩与上下文恢复", "planeUnbound": "尚未绑定 Enhanced Codex", "activationLabel": "启用状态", "environmentLabel": "接管状态", "inject": {"on": "已注入", "off": "未注入", "working": "注入中", "switchLabel": "注入 Enhanced Codex Runtime", "mean": {"staleLaunch": "Codex Desktop 现在正走在 Enhanced 上，但用的是较早那次启动的配置。要让最新的配置生效，重新启动 Codex Desktop。", "on": "Codex Desktop 正跑在 Vellum 的 bridge 上。第三方 Provider 的新对话由 Enhanced Codex 执行，OpenAI 官方模型维持原生 Codex。", "off": "Codex Desktop 跑在原生 Codex 上。CODEX_CLI_PATH 没有被 Vellum 动过。", "wanted": "Vellum 这边设置好了，但 Codex Desktop 还没接上，所以现在跑的还是原生 Codex。", "working": "正在验证可执行文件、接管 CODEX_CLI_PATH，并重新启动 Codex Desktop。", "armed": "重新启动 Codex Desktop 后生效。"}, "blocked": {"proxyStopped": "Proxy 没有启动。Proxy 没在跑的时候 Vellum 不会接管启动路径 —— 不然 Codex Desktop 会启动到一个后面没有数据面的 bridge。先启动 Proxy。", "stuck": "要求过注入，但路径没有被接管。下面的终端写着卡在哪一步；再扳一次开关可以重试。", "noCore": "这个 Vellum 构建里没有 Enhanced Codex core。这不是你漏了设置 —— core 由构建自己带，缺了代表安装不完整，请重新安装 Vellum。"}}, "term": {"idle": "还没跑过。扳动上面的开关，每一步会打印在这里。", "verify": "核对 Enhanced Codex 可执行文件", "verifyOk": "文件内容与这个版本预期的一致", "verifyFailed": "核对没过，什么都没有动", "restart": "接管 CODEX_CLI_PATH 并重新启动 Codex Desktop", "restartBack": "重新启动 Codex Desktop，回到原生 Runtime", "restartRefused": "没有重新启动", "adopt": "确认 Codex Desktop 接上了", "injected": "已注入 · {{profile}}", "notInjected": "Codex Desktop 没有接上 bridge", "release": "释放 CODEX_CLI_PATH", "releasedOk": "已释放，Codex Desktop 回到原生 Runtime", "envUnset": "（未设置）", "preflight": "检查前置条件", "proxyStopped": "Proxy 没有启动，接管会被释放掉。先启动 Proxy 再注入。", "armed": "启动路径已接管。下次启动 Codex Desktop 就会生效。", "alreadyInjected": "Codex Desktop 已经跑在这座 bridge 上了，不用重新启动 · {{profile}}", "missingHelper": "缺少辅助程序 {{name}}"}, "missingHelpers": "这支 Enhanced Codex 旁边少了官方安装有的辅助程序：{{names}}。Codex 在运行期才到自己旁边找它们，找不到会变成一个 Windows「找不到文件」对话框。对话与路由不受影响；会坏的只有用到那支程序的功能 —— 沙箱 shell 指令要 codex-windows-sandbox-setup.exe 与 codex-command-runner.exe；code mode 要 codex-code-mode-host.exe，而 code mode 默认是关的，关着就没有影响。", "enhancedBinaryHint": "由这个 Vellum 构建自己带，并用 enhanced-runtime.lock.json 里的哈希逐字节比对。换成别的只会验证失败，所以不开放选择。", "coreMissing": "这个构建没有带"},
      "updates": { "title": "软件更新", "description": "本体、Remote 套件与 Enhanced core 可独立更新。已下载的更新会保持待套用，直到符合套用条件。", "liveDisabled": "在发布签署配置完成前，自动更新保持停用。", "actionFailed": "更新操作失败：{{error}}", "autoCheck": "自动检查更新", "autoDownload": "自动下载更新", "channel": "通道", "stable": "稳定", "preview": "预览", "current": "当前版本", "available": "可用版本", "none": "无", "progress": "下载进度", "applyWhen": "套用条件", "notes": "发行说明", "failure": "失败原因", "check": "检查更新", "download": "下载", "apply": "套用", "cancel": "取消下载", "rollback": "回退", "hosts": "主机", "idleAuto": "空闲时自动更新", "idleHandoff": "预览：空闲时套用 Enhanced core（默认关闭）", "layerDisabled": "此层更新尚未在当前构建中启用。", "layer": { "desktop": "Vellum 本体", "remote": "Remote 套件", "core": "Enhanced Codex core" }, "condition": { "restartVellum": "已准备。重新启动 Vellum 后套用。", "hostIdle": "已下载。等待主机空闲。", "nextCoreStart": "已下载。下次核心启动时套用。", "download": "下载后暂存。", "failed": "见失败原因。", "idle": "已是最新。", "checking": "检查中…", "available": "有可用更新。", "downloading": "下载中…", "verifying": "验证中…", "staged": "已暂存。", "waitingForIdle": "等待空闲。", "waitingForRestart": "等待重新启动。", "applying": "套用中…", "validating": "验证中…", "applied": "已套用。", "blocked": "已阻止。", "rolledBack": "已回退。" }, "phase": { "idle": "待命", "checking": "检查中", "available": "可用", "downloading": "下载中", "verifying": "验证中", "staged": "已暂存", "waitingForIdle": "等待空闲", "waitingForRestart": "下次启动套用", "applying": "套用中", "validating": "验证中", "applied": "已套用", "blocked": "已阻止", "failed": "失败", "rolledBack": "已回退" } },
      "advanced": { "title": "高级设置", "description": "提供请求接收控制、Codex 安全重启和模型菜单恢复功能，仅供故障排除或维护使用。", "activeRequests": "进行中的请求", "drainTitle": "停止接收新请求", "draining": "已停止接收新请求；正在等待已有请求完成", "accepting": "目前正常接收请求", "drainHint": "不会中断进行中的请求；启用后，Vellum 会拒绝新请求，直到手动恢复。", "resume": "恢复接收请求", "stop": "停止接收新请求", "catalogVersion": "当前菜单版本", "notCreated": "尚未建立", "restartTitle": "重启 Codex", "restartHint": "安全结束已有请求后重启 Codex。", "restartAction": "重启 Codex", "restartAnyway": "仍要重启", "guideTitle": "初次设置向导", "guideHint": "重新查看初次设置或连接其他 Provider，不会重置现有设置。", "guideAction": "打开设置向导", "catalogHistory": "模型菜单版本记录", "rollback": "恢复", "noVersions": "还没有可恢复的版本。每次更新模型菜单会自动保留一份。", "restartRequired": "重启后生效", "applied": "已生效" },
      ...
      "errors": { "partialRefresh": "部分数据更新失败：{{detail}}", "reviewSave": "无法保存自动审查设置：{{detail}}", "reviewNoModelAvailable": "尚未配置任何已启用的审查模型，请先新增或启用一个 Provider 再切换为固定模型。", "reviewNoFallbackAvailable": "备援需要另一个不同 Provider 的已启用审查模型，请先新增或启用一个。", "restore": "恢复失败：{{detail}}", "drain": "无法更新新请求接收状态：{{detail}}", "restart": "无法重启 Codex：{{detail}}", "rollback": "无法恢复模型菜单：{{detail}}", "webSearchSave": "无法保存网页搜索设置：{{detail}}", "subagentSave": "无法保存子代理设置：{{detail}}", "logExport": "无法导出诊断日志：{{detail}}" }
    }
  },
  "today": {
    "title": "现状",
    ...
    "quota": {
      "tightest": "周额度剩余最少的供应商",
      "remaining": "额度剩余",
      "noData": "目前没有供应商回报额度"
    },
    "context": {
      "nearestThreshold": "最接近压缩门槛的工作阶段",
      "usage": "上下文用量",
    ...
    "sessions": { "title": "工作阶段", "count": "{{live}} 个活动中 / 共 {{total}} 个", "rest": "其余的工作阶段" },
    "providers": {
      "title": "Provider 状态",
      "noModels": "没有可用模型",
      "quotaFailed": "额度查询失败",
      ...
      "querying": "查询中…",
      "refresh": "重新查询",
      "empty": "没有要显示的供应商。到「设置」勾选，或到「模型」加一家。"
    },
    "health": {
      "title": "连接质量",
  ...
  "models": {
    "title": "模型",
    "ui": {
      "catalogTitle": "设置 Codex 模型菜单", "catalogHint": "先连接帐号或供应商，再挑出要送进 Codex 模型菜单的模型。", "wireUnknown": "无法自动判断，请选择", "customProvider": "自定义供应商", "errors": { "partialRefresh": "部分数据更新失败：{{detail}}", "noReset": "目前没有可使用的 Reset。", "confirmReset": "确定要为 {{account}} 使用一个 Reset？此操作会消耗一笔 Reset 额度，且无法恢复。", "resetSuccess": "OpenAI 额度已重置。", "resetCompleted": "Reset 已完成（{{code}}）。", "resetFailed": "Reset 失败：{{detail}}", "resetLookupFailed": "Reset 查询失败：{{detail}}", "oauthExpired": "授权码已过期，请重新登录。", "oauthLoginFailed": "ChatGPT 登录失败：{{detail}}", "oauthSwitchFailed": "无法切换 ChatGPT 账号：{{detail}}", "oauthRemoveFailed": "无法移除 ChatGPT 账号：{{detail}}", "oauthRefreshFailed": "无法更新 ChatGPT 登录：{{detail}}", "oauthLogoutFailed": "无法登出 ChatGPT：{{detail}}", "probeFailed": "无法探测此端点：{{detail}}", "opencodeApiKeyRequired": "请输入 OpenCode Zen API key。", "opencodeConnectFailed": "无法连接 OpenCode Zen：{{detail}}", "opencodeFreeAttachFailed": "OpenCode Go 已连接，但连接它的免费模型失败：{{detail}}", "modelProbeFailed": "无法验证 {{model}}：{{detail}}", "modelToolProbeFailed": "{{model}} 未返回 Codex 可用的结构化工具调用。", "routeRefreshFailed": "无法更新供应商状态：{{detail}}", "reprobeFailed": "重新探测能力失败：{{detail}}", "routeRemoveFailed": "无法删除供应商：{{detail}}", "providerModelRequired": "每个 Provider 至少要保留一个模型。", "catalogRefreshFailed": "无法更新导入 Codex 的模型：{{detail}}", "wireRequired": "无法自动判断 API 协议，请选择 Responses API 或 Chat Completions。", "modelRequired": "未探测到模型名称，请手动填写。", "routeAddFailed": "无法加入供应商：{{detail}}", "grokLoginFailed": "Grok 登录失败：{{detail}}", "grokStartFailed": "无法启动 Grok 登录：{{detail}}", "grokCancelFailed": "无法取消 Grok 登录：{{detail}}", "grokSwitchFailed": "无法切换 Grok 账号：{{detail}}", "grokRefreshFailed": "无法更新 Grok 账号：{{detail}}", "grokRemoveFailed": "无法移除 Grok 账号：{{detail}}", "detectAttention": "需补充", "detectFact": "已探测" },
      "confirm": {
        ...
        "removeRoute": { "title": "移除供应商", "confirmLabel": "移除供应商", "factProvider": "供应商", "factEffect": "影响", "effectValue": "这个供应商与它整份模型目录都会被移除；要恢复需要重新添加一次。" },
      ...
      "pool": { "title": "额度池", "onHint": "池裡的账号自動接手；每個账号可以保留一段每周额度。", "offHint": "關閉時維持手動切換，新請求使用你選定的账号。", "rules": "判定規則", "rulesTitle": "额度池判定規則", "rankHint": "左邊的號碼就是順序，用 ▲▼ 調整。", "availableThisWeek": "這周還可自動取用", "availablePercent": "池內這周還可自動取用 {{value}}%", "currentAndNext": "現在由 {{current}} 取用，接著是 {{next}}。", "stalled": "池內沒有可取用的账号；不會越過阀门或使用池外账号。", "empty": "池是空的。從下面的账号按「加入池」才會開始自動輪替。", "using": "取用中", "next": "下一個", "standby": "待命", "outside": "未加入池", "pause": "暫停", "resume": "恢復", "add": "加入池", "remove": "移出池", "moveUp": "往前一個順位", "moveDown": "往後一個順位", "burnable": "可用 {{value}}%", "atGate": "已到阀门", "gateRead": "阀门 {{floor}}%", "gateLabel": "{{account}} 的每周窗阀门", "gateValue": "阀门 {{floor}}%，這周剩 {{left}}%", "saveFailed": "無法儲存额度池：{{detail}}", "reason": { "paused": "已暫停", "weeklyGate": "每周窗到阀门", "fiveHour": "5 小時窗用完", "missingQuota": "额度資料不完整" }, "rule": { "gate": { "title": "阀门是地板", "body": "用到每周剩余量等於阀门就停手；以下留給你自己，100% 就完全不給自動輪替使用。" }, "fiveHour": { "title": "5 小時窗唯讀", "body": "它是上游節流；歸零時暫時輪不到，重置後自動回來。" }, "order": { "title": "顺序由你决定", "body": "编号就是轮替顺序，用 ▲▼ 调整；暂时用不了的账号会被跳过，其余账号的先后不变。" }, "pause": { "title": "暫停與移出", "body": "暫停保留設定但暫不使用；移出後自動輪替不會碰它。" }, "reset": { "title": "不自動花 Reset", "body": "额度池不會自動消耗 Reset；手動重設後阀门維持原值。" }, "empty": { "title": "無账号可用", "body": "所有池內账号受限時明確停止，不越過阀门，也不使用池外账号。" } } },
      ...
      "opencode": { "title": "OpenCode Zen", "description": "只需填入 API key 即可连接。这跟 OpenCode 官方 App 默认显示的一样，只有免费模型。付费 Zen 模型需要这个连接没办法验证的购买额度，如果你确实有，请到下方的手动加入供应商流程另外加。", "descriptionGo": "只需填入 API key 即可连接。OpenCode Go 是另一个端点上独立的小型模型库，不包含 OpenCode Zen 里的 GPT／Claude／Gemini 等高阶模型；如果你的 key 属于 Go 订阅，请选这个。Go 自己的端点不接受免费模型，所以 Vellum 会另外把 OpenCode Zen 的免费模型接成第二个供应商。", "freeRouteName": "{{name}}（免费模型）", "catalog": "模型库", "catalogZen": "OpenCode Zen（免费模型）", "catalogGo": "OpenCode Go", "catalogHint": "请选择你实际拥有的方案。Zen 只连接免费模型；Go 连接 Go 方案的模型库，并自动附带同样的免费模型。", "apiKey": "OpenCode Zen API key", "apiKeyPlaceholder": "粘贴 OpenCode Zen API key", "connect": "连接", "connecting": "连接中…", "connected": "已连接" },
      "addProvider": { "title": "加入供应商", "steps": { "endpoint": "粘贴端点", "endpointHint": "输入供应商 base URL。", "probe": "自动探测", "probeHint": "用最小请求探测模型、API 格式、串流和续传能力。", "add": "加入", "addHint": "确认结果并加入 Codex 模型菜单。" }, "endpoint": "端点网址", "apiKey": "API key（选填，加密存放）", "apiKeyPlaceholder": "本机或使用账号登录的端点可留空", "startProbe": "开始探测", "probing": "正在探测…", "add": "加入供应商", "reprobe": "重新探测" },
      "probe": { "reachable": "可以连接", "wire": "API 协议", "modelCount": "探测到 {{count}} 个模型", "modelsMissing": "未探测到，请填写", "context": "上下文窗口", "required": "需要填写", "streaming": "串流", "supported": "支持", "unsupported": "不支持", "toolCalling": "Codex 工具协议", "typedToolCalls": "已验证结构化工具调用", "toolCallingUnavailable": "未验证结构化工具调用", "chatOnly": "仅限对话", "reasoning": "推理内容", "detected": "可识别", "notDetected": "未探测到", "serverResume": "上游记住对话", "remembers": "会记住", "localHistory": "不记住，由 Vellum 补历史", "detectedModels": "探测到的模型", "selectionHint": "只有已勾选并通过验证的模型会加入 Codex 模型菜单。", "verifyToImport": "勾选以验证工具调用", "verificationRequired": "需要进行能力验证", "timeout": "探测超时", "unknown": "未知", "verifyModel": "验证", "verifyingModel": "验证中…",  "quotaWithRetry": "配额限制（HTTP 429 · 请于 {{seconds}} 秒后重试）", "unauthorized": "认证失败（HTTP 401/403）", "protocolError": "协议格式错误", "toolCallMissing": "未生成结构化工具调用", "unsupportedOpenCodeProtocol": "暂不支持 Anthropic／Google 原生协议", "defaultModel": "默认模型", "defaultModelHint": "所有模型都会加入 Codex 菜单；这里只决定供应商建立后预先使用哪一个。", "select": "请选择", "wireHint": "这是供应商接收请求的 API 协议，不是响应的 JSON 格式。", "manualPlaceholder": "未探测到，请手动填写", "settingsTitle": "端点探测设置", "requestSize": "请求大小", "preferredWire": "优先 API 格式", "preferredWireValue": "先试 Responses，再退回 Chat Completions", "contextSource": "上下文长度来源", "contextSourceValue": "依次使用手动设置、端点回报、模型缓存和 Codex 模型菜单。", "history": "对话历史保存", "historyValue": "上游不提供工作阶段续接时，由本机加密保存历史。" },
      "modelCatalog": { "rename": "改名", "renameProvider": "Provider 显示名称", "renameModel": "模型显示名称", "renameHint": "只改显示名称。送给供应商的仍是上游 id，Codex 既有的路由也不受影响。", "allowPrivateNetworkHttp": "允许明文 HTTP 连到私有网络", "allowPrivateNetworkHttpHint": "给局域网或 Tailscale 之类的地址用的：默认拒绝明文 HTTP 连到非本机端点，开启后才能连到私有网络（LAN、CGNAT、Tailscale）地址；仍然拒绝连到公网。", "renameModelPlaceholder": "留空就显示上游 id", "renameSave": "保存", "renameCancel": "取消", "free": "免费", "deprecated": "已下架", "vision": "图片", "visionOn": "这个模型可接受图片输入", "visionOff": "这个模型只吃文字；勾选后 Codex 才会开放附图", "visionHint": "图片支持无法自动探测——纯文字端点收到图片照样回 200 并让模型自己编。请按模型实际能力勾选。", "tokenUnit": "token", "effort": "Effort", "responses": "Responses", "chat": "Chat Completions", "title": "模型菜单", "hint": "已勾选的模型会加入 Codex 模型菜单。", "empty": "还没有供应商。用上面的流程加入第一家。", "countSelected": "{{selected}} / {{total}} 个", "count": "{{count}} 个", "unknownWindow": "窗口未知", "reasoning": "推理", "noReasoning": "无推理", "auto": "自动", "capabilityMissing": "尚未取得此 Provider 的模型能力数据。", "recent": "最近使用", "reprobe": "重新探测能力", "reprobeInProgress": "正在验证 {{count}} 个已选模型…", "reprobeSummary": "已验证 {{succeeded}}/{{targeted}} 个已选模型", "reprobeSummaryWithFailures": "已验证 {{succeeded}}/{{targeted}} 个已选模型，{{failed}} 个失败", "effortNotProbed": "尚未探测", "effortUnverified": "无法验证", "effortReasonIgnored": "Provider 对刻意发送的无效 Effort 值也返回成功，因此无法证明 low／medium／high 等层级确实生效。重复探测通常不会改变结果。", "effortReasonQuota": "Effort 探测被 Provider 配额或账号权限阻止{{detail}}", "effortReasonProvider": "Effort 探测期间发生 Provider 错误、超时或响应不完整{{detail}}", "effortReasonUnknown": "这次 Effort 探测未取得足以验证支持层级的证据{{detail}}", "retryEffortProbe": "重试 Effort 探测", "footerNote": "启用和停用会立即保存，但需要重启 Proxy 才会生效；模型菜单要等重启 Codex 后才会被重新读取。在两者完成前，状态会显示为“待生效”。", "windowEdit": "设定最大上下文长度", "windowHint": "设定这个模型的最大上下文长度", "windowAuto": "自动", "windowManual": "这是你手动填的值；清空后就改回探测到的值。", "windowUnavailable": "这个模型还没进 Codex 菜单，没有地方可以设。", "windowInvalid": "最大上下文长度要填大于 0 的数字，留空则改回自动。", "windowSaveFailed": "最大上下文长度存不进去：{{detail}}" }
    }
  },
  "context": {
    ...
    "transcript": {
      ...
      "chars": "{{value}} 字",
      "prompt": "送出的指示",
      "promptNote": "压缩 prompt，就是模型收到的样子。",
      "result": "写回来的内容",
      "resultNote": "从这里开始，这个对话带着走的东西。",
    ...
    "sessions": {
      ...
      "noMatch": "没有符合「{{query}}」的工作阶段。"
    },
    "title": "上下文", "compactionEyebrow": "上下文压缩", "compactionTitle": "上下文压缩状态与预览", "compactionHint": "请在 Codex App 输入 /compact 执行压缩；Vellum 显示压缩状态和交接记录。", "before": "压缩前", "after": "压缩后", "opaque": "Opaque", "legendAria": "上下文组成", "previewLoading": "正在计算压缩预览…", "footerNote": "压缩由执行该对话的 Codex runtime 管理；Vellum 只显示观测事件，旧版 journal 仅供只读查看。",
 "segmentAria": { "before": "{{label}}，压缩前 {{tokens}} token", "after": "{{label}}，压缩后 {{tokens}} token" },
  ...
  "log": {
    ...
    "requests": {
      ...
      "cached": "缓存 {{percent}}%",
      "connection": "conn {{id}}",
      "streamQualityTitle": "串流品质：{{quality}}",
  ...
  "remote": {
    ...
    "chore": {
      "restartNative": "套用新的配置与模型菜单。Proxy 不会停止，但进行中的 turn 可能被中断。",
      "takeoverNative": "Codex App 目前直接持有此主机的 daemon。接管后将改用 Vellum 管理的 native daemon，进行中的工作可能被中断。",
    ...
    "confirm": {
      ...
      "restartNative": {
        "changes": "重新启动主机上的 Codex native daemon，以套用新的配置与模型菜单。",
        "untouched": "Proxy 保持运行，配置文件与模型菜单都不会被改写。",
        "turns": "进行中的 turn 会被中断。"
      },
      "takeoverNative": {
        "changes": "将 Codex App 直接持有的 app-server 更换为 Vellum 管理的 native daemon。",
    ...
    "blocker": {
      ...
      "nativeDaemonAppOwned": "Codex App 目前直接持有此主机的 app-server，Vellum 无法接管。",
    ...
    "phase": {
      ...
      "applying": "应用部署计划",
      "verification": "验证 Proxy、daemon 与脱离就绪",
      "verified": "已就绪",
    ...
    "error": {
      "discovery": "读取连接配置失败。",
      "desktopCodexMismatch": "远程 Codex runtime 与当前 Desktop 协议不兼容。请先同步 Desktop Codex runtime，再重新操作。",
    ...
    "execution": {
      "title": "Proxy 执行账号",
      "independentHint": "Official 执行账号 B 只用于模型请求；切换它不会改变或中断 Remote 控制。",
    ...
    "sessions": {
      ...
      "turns_one": "{{count}} 个 turn · 最后一个 {{last}}",
      "turns_other": "{{count}} 个 turn · 最后一个 {{last}}",
      "observability": {
        "nativeAppServer": "可观测",
        "unsupported": "不支持",
  ...
  "onboarding": {
    ...
    "ui": { "providerSeparator": "、", "back": "回上一幕", "skipHint": "可以暂时不连接供应商，之后在“模型”页添加。", "skip": "先跳过", "continue": "继续", "enter": "进入 Vellum", "enterWithoutProxy": "暂不启动，直接进入", "start": "开始", "skipSetup": "我已设置过，直接进入", "unwritten": "第 {{step}} 幕，尚未进行", "visited": "（已读过，可返回）", "login": "登录", "collapse": "收起", "fillEndpoint": "填写端点", "connected": "已连接", "unavailable": "不可用", "waitingAuth": "等待授权", "notConnected": "未连接", "waitingAuthEllipsis": "等待授权…", "addAnother": "再连接一个", "enterCode": "在浏览器输入此代码", "providerType": "供应商类型", "customEndpoint": "自定义 API 端点", "opencodeHint": "OpenCode Zen 使用官方固定端点。只需输入 API key，Vellum 会获取并验证兼容模型。", "opencodeApiKey": "OpenCode Zen API key", "opencodeApiKeyPlaceholder": "粘贴 OpenCode Zen API key", "displayName": "显示名称", "displayNamePlaceholder": "例如 自建 vLLM", "endpoint": "端点", "optionalPlaceholder": "不需要则留空", "endpointHint": "留空表示不验证此端点。", "probing": "探测中…", "probeAndAdd": "探测并添加", "notConnectedYet": "尚未连接" },
    "overture": { "lead": "犊皮纸。", "history": "中世纪的犊皮纸很昂贵，写满后会刮掉重写，而没有刮干净的旧字迹会从底下透出来。", "mission": "这个程序做的也是同一件事：上下文满了不截断，重写一次，保留重要内容。", "subtitle": "只运行在你电脑上的 Codex 代理 · 接下来的四幕都写在这张纸上" },
    "what": { "axisTargets": "ChatGPT ／ Grok ／ 自定义", "title": "它站在中间", "lead": "Codex 继续访问原本的端点。Vellum 在中间把请求转给你选择的供应商——无需修改 Codex 配置即可切换供应商、模型或上下文。", "axisAria": "Codex CLI 经由本机 Vellum Proxy 连接 ChatGPT、Grok 或自定义端点", "client": "你正在使用", "local": "本机 · 不外送", "answering": "实际回答的", "noConfigTitle": "不修改配置", "noConfigBody": "启动时接管 Codex 端点，停止时原样恢复。不需要手动修改，也不会留下半成品设置。", "noTruncateTitle": "不硬截上下文", "noTruncateBody": "接近门槛时先整理成包含目标、已完成和下一步的检查点，再继续执行，而不是删除前文。", "reviewTitle": "批准可以交给其他模型", "reviewBody": "原本需要你按 y/n 的操作可以交由其他模型评估。沙箱、网络和文件权限保持不变。", "privacy": "全部运行在这台电脑上。Vellum 没有服务器，你的对话不会经过我们；凭证会加密保存在本机。" },
    "connect": { "title": "连接供应商", "lead": "一家就够开始。之后可以添加更多或同时启用几家——不同工作阶段可以使用不同供应商，额度快用完的会优先显示。", "chatgptClaim": "使用现有订阅额度", "chatgptDetail": "使用官方设备码登录，不需要 API key。订阅中的 Reset 额度也会带入，之后可在“模型”页使用。", "grokClaim": "使用官方 CLI 登录流程", "grokDetail": "需要在本机安装 Grok CLI。登录后可以连接多个账号并分别统计额度。", "grokUnavailable": "尚未安装 Grok CLI，或目前无法检测。", "customName": "自定义端点", "customClaim": "任何 OpenAI 兼容服务", "customDetail": "填写端点和 API key，Vellum 会自动探测模型和上下文长度。自建、代理、第三方服务都使用此路径。", "codexToolProtocolUnavailable": "端点可以连接，但没有模型返回 Codex 可执行的结构化工具调用。请先在 vLLM、Ollama 或 llama.cpp 启用工具调用协议。", "credentialNote": "凭证使用系统密钥链加密保存在本机，不会写入 Codex 配置或日志。" },
    "features": { "title": "这些功能已经可用", "lead": "无需额外设置即可生效。这一幕只告诉你功能在哪里，以及之后去哪里修改。", "reviewTerm": "自动审查\n可以换模型", "settingsPage": "设置", "reviewBody": "Codex 的批准请求可交给指定 Provider 和模型评估，也可以设置备援。主力额度用完时会显示备援中。", "resetTerm": "Reset 额度\n直接在这里使用", "modelsPage": "模型", "resetBody": "ChatGPT 账号的 Reset 额度显示在账号行，使用一笔后立即刷新。", "sessionTerm": "每个窗口\n独立计算", "todayPage": "现状", "sessionBody": "每个 Codex 窗口都有自己的对话和上下文窗口。现状页优先显示最接近压缩门槛的窗口，而不是平均成一个数字。" },
    "launch": { "title": "连接 Codex", "runningTitle": "正在使用 Vellum", "lead": "启动后 Vellum 会接管 Codex 端点设置，停止时原样恢复。此操作可随时撤回。", "runningLead": "端点已接管，请求会转发到已连接的供应商。停止后恢复安装 Vellum 之前的设置。", "startProxy": "启动 Proxy", "noProviderHint": "还没有连接供应商——可以先启动，但连接供应商后才会有模型回答。", "connectedProviders": "已连接的供应商", "howToStart": "如何开始", "howToStartValue": "打开新的 Codex 窗口。已有窗口需要重启才能使用 Vellum。", "howToStop": "如何停止", "howToStopValue": "在“现状”页点击“停止 Proxy 并恢复 Codex”", "reopenGuide": "重新查看导览", "reopenGuideValue": "“设置”页" }
  }
};
