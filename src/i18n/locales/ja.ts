...
const ja: ResourceTree = {
  "enhanced": {"heading":"Enhanced ランタイムの状態","lead":"各ルートの実行先、互換性検査の結果、モバイル接続の状態を表示します。","title":"Enhanced Core","subtitle":"実行先、互換性の証拠、モバイル接続","serving":"Enhanced Core は稼働中です","notServing":"Enhanced Core は稼働していません","sessions":"観測済みセッション","running":"実行中のターン","freshness":"観測状態","restartRequired":"新しい起動構成が準備できています。実行中のターンが終了してから再起動してください。","launchCoreDrift":"Codex Desktop がコアを更新しました。ターンがアイドルになると Vellum が Proxy を自動再起動します。その後 Codex を再起動してください。","now": "現在", "runningTurns_one": "{{count}} 件のターンが実行中", "runningTurns_other": "{{count}} 件のターンが実行中", "sessionCount_one": "{{count}} 件のセッション", "sessionCount_other": "{{count}} 件のセッション", "verdict": {"serving": "Codex Desktop は Enhanced Core を経由しています。", "servingOtherLaunch": "Enhanced は稼働していますが、前回の起動構成のままです。Codex を再起動すると現在の構成に移ります。", "stoppedAt": "起動シーケンスが「{{link}}」ステージで停止しています。", "disabled": "Enhanced Core は無効です。Codex Desktop は自身のコアで動いています。"}, "chain": {"title": "起動シーケンス", "artifact": "コンポーネント検証", "armed": "パス引き継ぎ", "adopted": "Bridge 接続", "inPlace": "実行確認"}, "mark": {"blocked": "失敗", "waiting": "待機中", "inPlace": "有効"}, "whyStopped": "「{{link}}」ステージで停止した理由", "whyNoted": "実行中、ただし注意点あり", "protocol": {"verified": "検証済み", "unverified": "未検証", "incompatible": "非互換"}, "protocolUnrun": "比較が実行されませんでした", "unverifiedNote": "この Codex Desktop は検証されていません。ルーティング対象のメソッドはすべて通りますが、差分は実在し未検証です —— 使えますが正しさは保証されません。", "missingHelpers": "公式インストールにあって Enhanced コアにないヘルパー：{{list}}。チャットとルーティングは影響を受けませんが、サンドボックス実行は失敗します。", "routed": "ルーティング対象", "delta": {"methodUnservable": "このメソッドは提供できません", "methodUnknownToDesktop": "Desktop がこのメソッドを知りません", "fieldNewlyRequired": "必須フィールドが追加されました", "fieldRemoved": "フィールドが削除されました"}, "environment": {"leased": "保持中", "released": "返却済み", "orphanedBridge": "取り残された bridge", "foreignValue": "他が保持", "unreadable": "読み取れません"}, "bridgeProcess": "Bridge プロセス", "bridgeState": "Bridge の状態", "children": "子プロセス", "launch": "起動", "relayNote": "スマートフォンの接続は、ハンドシェイク・タスク一覧・メッセージ読み込み・ライブイベント・タスク制御の 5 段すべてを通過して初めて成立します。通らなかった段が接続できない理由です。", "staleWarning":"最後の観測結果は古い可能性があります。","compatibility":"バージョンと互換性","activeRuntime":"稼働中の runtime","candidateRuntime":"次回起動の runtime","structure":"Schema 比較","qualification":"直近の検証","notObserved":"未観測","observed":"観測済み","evidenceNote":"Schema の一致は構造上の証拠です。Desktop やモバイルの実機検証を意味しません。","differences":"差分と阻害要因","relay":"Relay 状態","clients":"接続中クライアントのバージョン","handshake":"ハンドシェイク","list":"タスク一覧","history":"メッセージ読み込み","stream":"ライブイベント","control":"タスク操作","failureStage":"直近の失敗段階","plane":"実行先","all":"すべて","empty":"今回の起動ではセッションがまだ観測されていません。過去の紐付けは現在の接続ではありません。","session":"セッション","state":"状態","lastActivity":"最終アクティビティ","parent":"親タスク","diagnostics":"診断","recheck":"互換性を再確認","export":"診断をエクスポート","exported":"保存しました","states":{"starting":"起動中", "ready":"準備完了", "degraded":"機能低下", "stopped":"停止", "transportReady":"転送準備完了", "unknown":"不明","current":"最新","stale":"古い","offline":"オフライン","unavailable":"取得不可","running":"実行中","idle":"待機中","approval":"承認待ち","unloaded":"アンロード済み","observed":"観測済み","attached":"接続済み","failed":"失敗"}},
  "common": { "expiresAt": "失効：{{month}}月{{day}}日 {{time}}（{{zone}}）", "expiredAlready": "失効済み", "expiresInMinutes": "残り {{value}} 分", "expiresInHours": "残り {{value}} 時間", "expiresInDays": "残り {{value}} 日","emDash": "—", "none": "—", "listSeparator": "、", "itemSeparator": "、", "loading": "読み込み中…", "processing": "処理中…", "refreshing": "更新中…", "refresh": "更新", "reorganize": "再整理", "save": "保存", "cancel": "キャンセル", "confirm": "確認", "close": "閉じる", "remove": "削除", "enabled": "有効", "disabled": "無効", "yes": "はい", "no": "いいえ", "on": "オン", "off": "オフ", "unknown": "不明", "provider": "プロバイダー", "model": "モデル", "proxy": "Proxy", "codexCatalog": "Codex モデル一覧", "justNow": "たった今", "minutesAgo": "{{count}} 分前", "hoursAgo": "{{count}} 時間前", "daysAgo": "{{count}} 日前", "resetAt": "{{month}}月{{day}}日 {{time}} にリセット", "previousPage": "前のページ", "nextPage": "次のページ", "pageOf": "{{page}} / {{total}} ページ", "shortcutTitle": "{{label}}（Ctrl+{{n}}）", "statusUpdateFailed": "状態の更新に失敗しました：{{detail}}", "errorWithDetail": "{{message}}：{{detail}}", "connectionFailed": "接続に失敗しました", "operationFailed": "操作に失敗しました", "loadFailed": "読み込みに失敗しました", "saveFailed": "保存に失敗しました", "visible": "表示", "hidden": "非表示", "totalItems_one": "全 {{count}} 件", "totalItems_other": "全 {{count}} 件", "itemsNeedAttention_one": "件の対応が必要です", "itemsNeedAttention_other": "件の対応が必要です", "notice": {"info": "説明", "warn": "注意", "error": "失敗"}, "dismiss": "閉じる"},
  "navigation": {
    "mainAria": "メインナビゲーション",
    "today": {
      "label": "現況",
  ...
  "status": {
    ...
    "remedy": {
      ...
      "restartCodex": "Codex を再起動するとモデル一覧に表示されます"
    }
  },
  "vocabulary": {
  ...
  "review": {
    "policy": {
      ...
      "failover": {
        "label": "指定優先、失敗時は予備",
        "blurb": "指定モデルを優先し、クォータ切れや接続失敗時は予備モデルへ切り替えてレビューを継続します。"
      }
    }
  },
  "heatmap": {
  ...
  "runtime": {"notice": {"codexConfigStillPointedAtVellum": "Codex の設定は前回から Vellum を指したままです。Proxy を起動し、Codex App を再起動すると続けて使えます。", "codexRunning": "Codex が実行中です。Proxy とモデルカタログを読み込むには再起動してください", "proxyStoppedCodexRestartRequired": "Proxy を停止し設定を復元しました。古い Proxy／Bridge 接続から離れるには Codex を再起動してください", "codexRestartDetected": "Codex の再起動を検出しました。Proxy とモデルカタログを読み込みました", "routesAndCatalogUpdated": "Provider 設定とモデルカタログを更新しました。Vellum Proxy と Codex の再起動後に反映されます", "catalogRestored": "モデルカタログを復元しました。Codex の再起動が必要です", "catalogUpdated": "モデルカタログを更新しました", "enhancedDesktopRuntimeChanged": "Enhanced Codex Runtime の設定を変更しました。Codex を再起動して適用してください", "enhancedLaunchCoreRepaired": "Codex Desktop がコアを更新したため、Vellum が Proxy を自動再起動して新しい起動設定を準備しました。Codex を再起動してください（以前の起動 {{launchId}}）", "enhancedLaunchCoreRepairFailed": "Codex Desktop の更新後に Vellum が Proxy を自動再起動できませんでした：{{reason}}。Proxy を手動で再起動してから Codex を再起動してください。", "remoteOfficialAccountSwitchNotFollowed": "リモートホスト {{host}} はアカウント切替に追随しませんでした。Remote Manager でペアリングまたは整合してください。理由：{{detail}}", "officialAccountSwitchNativePlane": "Official GPT は未改変の Codex コア上です。Enhanced bridge が有効なあいだ、Vellum のアカウント切替は Codex Desktop のログインを置き換えません", "enhancedDesktopBridgeReady": "Codex を再起動し、Enhanced bridge 経由で実行しています（起動 {{launchId}}）", "enhancedDesktopBridgeFailed": "Codex を再起動しましたが、Enhanced bridge が失敗しました：{{reason}}", "enhancedDesktopRuntimeNotArmed": "Proxy は起動しましたが、Enhanced Codex は有効化されていません。サードパーティ Provider のスレッドはネイティブ Codex で実行されます。理由：{{detail}}", "enhancedDesktopBridgeNotObserved": "Codex を開き直しましたが、起動 {{launchId}} に対する Enhanced bridge の報告がありません。Enhanced は実行されていません", "routeHotSwapped": "ルートをホットスワップしました", "slotSwitched": "{{slot}} を {{model}} に切り替えました", "restartSucceeded": "Codex を安全に再起動しました。新しい実行時設定を読み込みました", "restartNotDetected": "Codex の起動要求を送信しましたが、5 秒以内に App を検出できませんでした。手動で開いてください", "restartProcessStillRunning": "Codex が完全に終了していません（停止コード {{exitCode}}）。再起動を中止しました", "restartBlockedByActiveRequests_one": "{{count}} 件のリクエストが実行中です", "restartBlockedByActiveRequests_other": "{{count}} 件のリクエストが実行中です", "restartBlockedByCodexTurn_one": "Codex Desktop で {{count}} 件の会話が進行中です。今再起動すると、まだ保存されていない内容が失われます", "restartBlockedByCodexTurn_other": "Codex Desktop で {{count}} 件の会話が進行中です。今再起動すると、まだ保存されていない内容が失われます", "restartExecutableMissing": "検証可能な Codex App の実行ファイルが見つかりません", "restartExecutableInvalid": "Codex App の実行ファイルが存在しないか、絶対パスではありません", "restartUnavailableInPreview": "ブラウザープレビューでは Codex を再起動しません", "usageOAuthNotConfigured": "Vellum に OpenAI OAuth が設定されていません。OpenAI の集計は Proxy の記録から推定します", "usageProfileUnavailable_one": "{{count}} 件の OpenAI OAuth アカウントの Codex Token 統計を一時的に取得できません", "usageProfileUnavailable_other": "{{count}} 件の OpenAI OAuth アカウントの Codex Token 統計を一時的に取得できません", "webSearchDisabledMissingBraveKey": "Brave Search の API キーが未設定のため、サードパーティのウェブ検索は無効化されました。設定でキーを追加すると再度有効にできます。"}, "alerts": {"label": "ランタイム警告"}},
  "settings": {
    "language": {
      "title": "言語",
  ...
  "today": {
    ...
    "quota": {
      "tightest": "週次残量が最も少ないプロバイダー",
      "remaining": "残量",
      "noData": "残量を報告したプロバイダーはありません"
    },
    "context": {
    ...
    "sessions": { "title": "セッション", "count": "アクティブ {{live}} / 合計 {{total}}", "rest": "以降のセッション" },
    "providers": {
      ...
      "querying": "確認中…",
      "refresh": "更新",
      "empty": "表示するプロバイダーがありません。設定で選択するか、モデル画面で追加してください。"
    },
    "health": {
      "title": "接続品質",
  ...
  "models": {
    ...
    "ui": {
      ...
      "confirm": {
        ...
        "removeRoute": { "title": "プロバイダーを削除", "confirmLabel": "プロバイダーを削除", "factProvider": "プロバイダー", "factEffect": "影響", "effectValue": "このプロバイダーとモデルカタログ全体が削除されます。復元するには最初から追加し直してください。" },
      ...
      "pool": { "title": "Quota pool", "onHint": "Pooled accounts take over automatically; reserve part of each weekly allowance.", "offHint": "Manual selection remains in effect for new requests.", "rules": "Decision rules", "rulesTitle": "Quota pool decision rules", "strategyLabel": "Rotation order", "strategy": { "rank": "Manual rank", "most": "Most remaining", "soonest": "Soonest reset" }, "rankHint": "The numbers are the order; use ▲▼ to adjust it.", "computedRankHint": "The numbers show the computed order.", "availableThisWeek": "Available to the pool this week", "availablePercent": "{{value}}% available this week", "currentAndNext": "Using {{current}} now; {{next}} is next.", "stalled": "No pooled account is usable; Vellum will not cross a gate or use an external account.", "empty": "The pool is empty. Add an account below to begin rotation.", "using": "In use", "next": "Next", "standby": "Standby", "outside": "Not in pool", "pause": "Pause", "resume": "Resume", "add": "Add to pool", "remove": "Remove", "moveUp": "Move earlier", "moveDown": "Move later", "weeklyWindow": "Weekly window", "fiveHourWindow": "5-hour window · upstream throttle, no gate", "burnable": "{{value}}% spendable", "atGate": "At gate", "leftAndGate": "{{left}}% left · {{floor}}% gate", "fiveHourEmpty": "Exhausted", "fiveHourLeft": "{{value}}% left", "gateLabel": "Weekly gate for {{account}}", "gateValue": "{{floor}}% gate, {{left}}% left", "saveFailed": "Could not save quota pool: {{detail}}", "reason": { "paused": "Paused", "weeklyGate": "Weekly gate reached", "fiveHour": "5-hour window exhausted", "missingQuota": "Quota data incomplete" }, "rule": { "gate": { "title": "The gate is a floor", "body": "Automatic use stops at the weekly gate; the portion below it stays reserved. A 100% gate seals the account." }, "fiveHour": { "title": "The 5-hour window is read-only", "body": "It is an upstream throttle. The account waits when exhausted and returns after reset." }, "strategy": { "title": "Explainable order", "body": "Manual rank is adjustable; other strategies use current quota readings." }, "pause": { "title": "Pause or remove", "body": "Pause keeps settings but excludes the account temporarily; remove keeps rotation from using it." }, "reset": { "title": "Reset stays manual", "body": "The pool never consumes a Reset automatically. Manual resets preserve the gate." }, "empty": { "title": "No usable account", "body": "Vellum stops explicitly instead of crossing a gate or using an external account." } } },
 ...
 "segmentAria": { "before": "{{label}}、圧縮前 {{tokens}} token", "after": "{{label}}、圧縮後 {{tokens}} token" },
  ...
  "log": {
    ...
    "requests": {
      ...
      "subagentChildren_one": "子エージェント {{count}} 件",
      "subagentChildren_other": "子エージェント {{count}} 件",
  ...
  "remote": {
    "title": "リモートホスト",
    "blurb": "SSH ホストを Codex App がそのまま使える状態に収束させます。チャット・thread・session は引き続きホスト上の Codex native daemon が担当します。",
    "rescan": "再探索",
    "rescanning": "探索中…",
    ...
    "releaseBlocked": "同梱の配備パッケージが署名検証を通過していないため、Codex のインストールと Agent の更新は無効です。配備済みホストの計画と同期は引き続き利用できます。",
    ...
    "verdict": {
      ...
      "unmanaged": "このホストはまだ Vellum の管理下にありません。配備すれば Codex App からそのまま使えます。",
      "readyToPlan": "Proxy は動いていますが、Codex のモデル一覧はまだ引き継いでいません。",
      "drifted": "ホスト上の設定が Vellum の記録と違います。再収束が必要です。",
    ...
    "chore": {
      "restartNative": "新しい設定とモデル一覧を反映します。Proxy は止まりませんが、実行中の turn が中断される場合があります。",
    ...
    "confirm": {
      ...
      "bootstrap": {
        "changes": "Codex の設定ファイル・モデル一覧・Proxy と必要な資格情報。初回は検証済みのモデルをすべて適用し、以降は保存した選択を引き継ぎます。",
        "untouched": "ホスト上のプロジェクト、通常の Codex thread、自分で入れたソフトウェア。",
        "turns": "拒否されます。強制的に中断することはありません。"
      },
      "restore": {
        "changes": "Codex 本来の設定ファイルとモデル一覧を復元し、アカウントの lease を返却し、Vellum 管理の Proxy と runtime を停止します。",
        "untouched": "あなたのプロジェクト、通常の Codex thread、ホスト上の Codex 本体と Agent。",
        "turns": "拒否されます。強制的に中断することはありません。"
      },
      "restartNative": {
        "changes": "ホスト上の Codex native daemon を再起動し、新しい設定とモデル一覧を反映します。",
        "untouched": "Proxy は動いたままで、設定ファイルとモデル一覧は書き換えません。",
        "turns": "実行中の turn は中断されます。"
      },
      "takeoverNative": {
        "changes": "Codex App が直接保持している app-server を、Vellum 管理の native daemon に置き換えます。",
        "untouched": "設定ファイル・モデル一覧・ログイン済みのアカウント。",
        "turns": "Codex App 側で実行中の作業が中断される場合があります。"
      },
      "installCodex": {
        "changes": "同梱の pinned Codex CLI をホストに導入し、manifest と digest を検証してからアトミックに差し替えます。",
        "untouched": "Codex の設定ファイル・モデル一覧・既存の thread。",
      ...
      "updateAgent": {
        ...
        "turns": "Agent 自身の再起動が必要なため、リモート操作が一時的に途切れます。"
      },
      "syncDesktopCodex": {
        "changes": "Desktop core と完全に一致する OpenAI 公式 Linux artifact を取得し、発行元 digest と app-server プロトコルを検証してアトミックに導入し、リモート daemon を再起動します。",
        "untouched": "Vellum Proxy イメージ、モデル一覧、アカウント、プロジェクト、既存の task。",
        "turns": "リモート daemon の再起動時に、実行中の turn が中断される場合があります。"
      },
      "stopAppOwned": {
        "changes": "Codex App が直接保持している app-server を安全に停止し、配備をもう一度実行します。",
        "untouched": "設定ファイル・モデル一覧・ログイン済みのアカウント。",
    ...
    "blocker": {
      ...
      "nativeDaemonAppOwned": "Codex App がこのホストの app-server を直接保持しているため、Vellum が引き継げません。",
    ...
    "phase": {
      ...
      "nativeDaemon": "常駐可能な Codex リモート制御を有効化",
      "deploymentPlan": "対象モデルと資格情報を洗い出し",
      "deploymentApply": "Proxy・資格情報・モデル一覧を導入",
      "applying": "配備計画を適用",
      "verification": "Proxy・daemon・切断後の継続を検証",
      "verified": "準備完了",
      "restorePreflight": "実行中の turn と管理状態を確認",
      "restoreLease": "Codex の設定とモデル一覧を復元",
    ...
    "error": {
      ...
      "actionFailed": "「{{action}}」に失敗しました。上のホスト状態は読み直し済みで、現在の状態です。",
    ...
    "detail": {
      ...
      "daemonStopped": "停止中",
      "daemonOwner": "Daemon の所有",
      "durable": "常駐可",
      "notDurable": "常駐不可",
      "codexSource": "Codex の入手元",
      "releaseTrust": "パッケージの信頼",
    ...
    "control": {
      ...
      "sameAccountHint": "Desktop とスマートフォンは同じ ChatGPT アカウントと workspace を使う必要があります。ペアリングで daemon の ID は変わりません。",
      "deviceHint": "短期デバイスペアリング情報：",
      "expiresAt": "{{when}} に失効"
    },
    "execution": {
      "title": "Proxy 実行アカウント",
      "independentHint": "Official 実行アカウント B はモデル要求だけに使用され、切り替えても Remote 接続には影響しません。",
    ...
    "danger": {
      "body": "このホストに対する Vellum の管理を取り消し、Codex を配備前の状態に戻します。これは切断ボタンではありません —— もう一度使うには再配備が必要です。プロジェクトと通常の Codex thread は削除されません。"
    },
    "sessions": {
