...
const ja: ResourceTree = {
  ...
  "models": {
    ...
    "ui": {
      ...
      "fiveHour": { "start": "5h を開始", "starting": "開始中…", "hint": "このアカウントでごく小さな Luna リクエストを 1 件送信し、5 時間の利用枠を開始します。少量のクォータを使用しますが、Reset 枠は消費しません。", "success": "5 時間の利用枠を開始し、使用量を更新しました。", "failed": "5 時間の利用枠を開始できませんでした：{{detail}}", "refreshFailed": "開始リクエストは完了しましたが、使用量を更新できませんでした：{{detail}}" },
