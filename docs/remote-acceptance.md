...
## 7. M30–M32 pinned 安裝與 desired state 驗收
...
## 8. Legacy active-lease／missing-key boundary key 升級驗收
...
- 上述驗收全部通過後：`remote manager production-qualified`。
